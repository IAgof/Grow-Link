...
<div class="shop-description" style="text-align: justify; margin-bottom: 100px" >
</div>
			...
			<?php } ?>
			<div class="seller-description" style="margin-bottom:200px; margin-top:5px; "><?php echo $seller['description']; ?></div>
