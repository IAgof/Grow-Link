...
//										var date_format = dd+'-'+mm+'-'+yyyy;
							...
							//		fecha_fin = '2016-04-04';
								...
								function fncActualizar()
									...
									$(function () {
										$.get('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Temperature/average&'+temp_opt_min+'&'+temp_opt_max+'', function(data){
									    var gaugeOptions = {
									        chart: {
									            type: 'solidgauge'
									        },
									...
									$(function () {
												...
												$.get('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Air_humidity/average&'+hum_opt_min+'&'+hum_opt_max+'', function(data){
					...
					$(function () {
								$.getJSON('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Temperature/mean', function (data) {
...
//								console.log('entra    ' + data);
						        $('#container-graph-temp').highcharts({
						            ...
						            series: [{
						                ...
						                data: data
											...
											$(function () {
														$.getJSON('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Air_humidity/mean', function (data) {
	...
	//													console.log('entra    ' + data);
												...
												$.get('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Temperature/last', function (data) {
				...
				//									document.getElementById('rang-opt-temp').innerHTML = 'Rango óptimo de Temperatura: ' +temp_opt_min+ ' a ' +temp_opt_max;
												...
												$.get('http://217.125.140.200:4004/'+user+'/'+fecha_ini+'/'+fecha_fin+'/'+mota+'/Air_humidity/last', function (data) {
													data = Number(data).toFixed(1);
								...
								<div id="dashboard" style="max-width: 80%; margin: 0 auto;">
									<div id="temperatura">
										...
										<div id="rigth" style="float: left; width: 30%; margin: 0 auto: min-width:300px;">
											...
											<div id="rang-opt-temp" style="width: auto; height: auto; margin: 0 auto; text-align: center;">
												...
												<input type="text" name="temp_opt_min" id="temp_opt_min" value="20" style="width: 50px; text-align: center;" onchange="javascript:fncActualizar();"> a
												<input type="text" name="temp_opt_max" id="temp_opt_max" value="25" style="width: 50px; text-align: center;" onchange="javascript:fncActualizar(); ">
													ºC
											</div>
											<div id="container-porcent-temp" style="width: auto; height: 250px; margin: 0 auto; min-width: 300px"></div>
										</div>
									</div>
									...
									<div id="humedad" style="clear: both;">
										...
										<div id="rigth" style="float: left; width: 30%; margin: 0 auto: min-width:300px;">
											...
											<div id="rang-opt-hum" style="width: auto; height: auto; margin: 0 auto; text-align: center;">
												Rango de humedad óptima
												<input type="text" name="hum_opt_min" id="hum_opt_min" value="30" style="width: 50px; text-align: center;" onchange="javascript:fncActualizar();"> a
												<input type="text" name="hum_opt_max" id="hum_opt_max" value="45" style="width: 50px; text-align: center;" onchange="javascript:fncActualizar(); ">
												 %
												</div>
											<div id="container-porcent-hum" style="width: auto; height: 250px; margin: 0 auto; min-width: 300px"></div>
										</div>
									</div>
								</div>

<!--
								<img src="../../../../../../image/catalog/zona.jpg" width="35%" height="auto" margin="auto" alt="Mapa zona geografica del cultivo" usemap="#zonas">
									<map name="zonas" onclick="javascript:fncActualizar();>
									  <area shape="rect" coords="10,130,200,300" value="mote0" alt="Zona 1" >
									  <area shape="rect" coords="210,130,400,300" value="mote1" alt="Zona 2">
									  <area shape="rect" coords="410,130,600,300" value="mote2" alt="Zona 3">
									</map>
								</img>
-->
									<form name="formulario">
										<select name="lista" onchange="javascript:fncActualizar();">
											<option value="mote0">Zona 1</option>
											<option value="mote0">Zona 2</option>
