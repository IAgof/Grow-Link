  ...
  <ul class="content dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><strong class="button btn btn-outline-inverse"><i class="fa fa-shopping-cart"></i> <?php echo $text_cart; ?></strong></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>"><strong class="button btn btn-outline-inverse"><i class="fa fa-share"></i> <?php echo $text_checkout; ?></strong></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
