		...
		<div class="content">
			<div class="wapper">
				<div class="description">
					<div class="box-heading"><i class="fa fa-plus">&nbsp;&nbsp;</i><span class="title"><?php echo $objlang->get("entry_newsletter");?></span></div>
					<br/>
				...
				<div class="button-submit">
					<button type="submit" name="submitNewsletter" class="btn btn-primary"><span class="fa fa-envelope-o"></span></button>
				</div>	
