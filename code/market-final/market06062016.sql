...
INSERT INTO `oc_address` VALUES (3,3,'victor','nunez','','diego velazquez 19','','mojados','47250',195,3018,''),(4,4,'victor','nunez','','calle sin nombre 15','','alcobendas','48202',195,3001,''),(5,5,'victor','nunez','','','','','',0,0,''),(6,4,'viactor','nunez','','diego velazquez 19','diego velazquez 19','mojados','47250',195,3018,'');
/*!40000 ALTER TABLE `oc_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc_advertikon_stripe_customer`
--

DROP TABLE IF EXISTS `oc_advertikon_stripe_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_advertikon_stripe_customer` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `oc_customer_id` int(11) unsigned DEFAULT NULL,
  `stripe_id` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `date_added` datetime DEFAULT NULL,
  `date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `description` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `metadata` text COLLATE utf8_bin,
  PRIMARY KEY (`id`),
  KEY `oc_customer_id` (`oc_customer_id`,`stripe_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oc_advertikon_stripe_customer`
--

LOCK TABLES `oc_advertikon_stripe_customer` WRITE;
/*!40000 ALTER TABLE `oc_advertikon_stripe_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc_advertikon_stripe_customer` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2016-04-26 14:32:29','2016-04-26 14:32:29');
...
INSERT INTO `oc_api_ip` VALUES (1,1,'127.0.0.1'),(2,1,'127.0.0.1');
...
INSERT INTO `oc_api_session` VALUES (9,1,'xf7mCrIfk6r3Yh2UmZOKogYRDErrXh0b','le1mj3gk3so75dl7p1s5n9ppd3','temp_session_57553c1462a43','127.0.0.1','2016-06-06 11:02:12','2016-06-06 11:02:12'),(7,1,'XGnT5h0LCuN8WP8MMTlfLs6dJtxJzFWc','le1mj3gk3so75dl7p1s5n9ppd3','temp_session_57553b4470c5a','127.0.0.1','2016-06-06 10:58:44','2016-06-06 10:58:44'),(8,1,'srK7phkLfQT8JrfasttUqBcn35t6ZVjA','le1mj3gk3so75dl7p1s5n9ppd3','temp_session_57553b4914048','127.0.0.1','2016-06-06 10:58:49','2016-06-06 10:59:58');
...
INSERT INTO `oc_attribute_description` VALUES (12,1,'unit'),(12,2,'Unidad de medida');
...
INSERT INTO `oc_attribute_group_description` VALUES (7,2,'Unidad de Medida'),(7,1,'unit'),(8,2,'Producto de Temporada'),(8,1,'seasonal product');
...
INSERT INTO `oc_banner` VALUES (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1),(9,'sliderHome',1);
...
INSERT INTO `oc_banner_image` VALUES (101,9,'','catalog/FondoVerduras.png',0),(87,6,'index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,'','catalog/demo/manufacturer/nfl.png',0),(95,8,'','catalog/demo/manufacturer/redbull.png',0),(96,8,'','catalog/demo/manufacturer/sony.png',0),(91,8,'','catalog/demo/manufacturer/cocacola.png',0),(92,8,'','catalog/demo/manufacturer/burgerking.png',0),(93,8,'','catalog/demo/manufacturer/canon.png',0),(88,8,'','catalog/demo/manufacturer/harley.png',0),(89,8,'','catalog/demo/manufacturer/dell.png',0),(90,8,'','catalog/demo/manufacturer/disney.png',0),(99,7,'','catalog/FondoVerduras.png',0),(97,8,'','catalog/demo/manufacturer/starbucks.png',0),(98,8,'','catalog/demo/manufacturer/nintendo.png',0);
...
INSERT INTO `oc_banner_image_description` VALUES (101,2,9,'Home'),(87,1,6,'HP Banner'),(93,1,8,'Canon'),(92,1,8,'Burger King'),(91,1,8,'Coca Cola'),(90,1,8,'Disney'),(89,1,8,'Dell'),(101,1,9,'Home'),(88,1,8,'Harley Davidson'),(94,1,8,'NFL'),(95,1,8,'RedBull'),(96,1,8,'Sony'),(97,1,8,'Starbucks'),(98,1,8,'Nintendo'),(99,2,7,'Qfresh.co'),(87,2,6,'HP Banner'),(93,2,8,'Canon'),(92,2,8,'Burger King'),(91,2,8,'Coca Cola'),(90,2,8,'Disney'),(89,2,8,'Dell'),(99,1,7,'Qfresh.co'),(88,2,8,'Harley Davidson'),(94,2,8,'NFL'),(95,2,8,'RedBull'),(96,2,8,'Sony'),(97,2,8,'Starbucks'),(98,2,8,'Nintendo');
...
INSERT INTO `oc_cart` VALUES (2,1,'168raibrq49tn38bgk6ntbcj27',43,0,'[]',1,'2016-04-26 14:56:37'),(12,4,'uuel73isp5b9t3rn9prfr6p230',54,0,'[]',4,'2016-04-28 12:36:54'),(14,4,'uuel73isp5b9t3rn9prfr6p230',56,0,'{\"237\":\"54\",\"238\":\"56\",\"239\":\"63\",\"240\":\"72\"}',4,'2016-04-28 15:23:40'),(15,4,'uuel73isp5b9t3rn9prfr6p230',56,0,'{\"237\":\"52\",\"238\":\"61\",\"239\":\"65\",\"240\":\"69\"}',4,'2016-04-28 15:24:09'),(16,4,'uuel73isp5b9t3rn9prfr6p230',56,0,'{\"241\":\"79\",\"242\":\"82\",\"243\":\"86\",\"244\":\"94\"}',4,'2016-04-28 15:48:06'),(22,3,'le1mj3gk3so75dl7p1s5n9ppd3',50,0,'[]',12,'2016-06-06 10:58:53'),(23,3,'le1mj3gk3so75dl7p1s5n9ppd3',51,0,'[]',4,'2016-06-06 10:58:53'),(24,3,'le1mj3gk3so75dl7p1s5n9ppd3',52,0,'[]',4,'2016-06-06 10:58:53');
...
INSERT INTO `oc_category` VALUES (61,'',0,1,1,4,1,'2016-04-27 15:13:55','2016-04-27 15:15:34'),(62,'',0,1,1,3,1,'2016-04-27 15:14:18','2016-04-28 16:33:56'),(60,'',0,1,1,2,1,'2016-04-27 15:13:32','2016-04-29 14:55:51'),(64,'',59,1,1,0,1,'2016-04-27 16:10:18','2016-04-27 16:10:18'),(65,'',59,1,1,0,1,'2016-04-27 16:10:56','2016-04-27 16:11:12'),(72,'',62,0,1,0,1,'2016-04-27 16:24:23','2016-04-27 16:24:35'),(71,'',62,0,1,0,1,'2016-04-27 16:23:56','2016-04-27 16:23:56'),(70,'',60,0,1,0,1,'2016-04-27 16:19:56','2016-04-27 16:19:56'),(69,'',60,0,1,0,1,'2016-04-27 16:19:21','2016-04-27 16:19:21'),(68,'',60,0,1,0,1,'2016-04-27 16:18:26','2016-04-27 16:18:52'),(67,'',60,1,1,0,1,'2016-04-27 16:17:49','2016-04-27 16:18:04'),(66,'',60,0,1,0,1,'2016-04-27 16:17:08','2016-04-27 16:17:30'),(59,'',0,1,1,0,1,'2016-04-27 13:04:01','2016-04-27 13:04:01');
...
INSERT INTO `oc_category_description` VALUES (64,2,'Fruta','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','fruta','',''),(60,1,'despensa','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','despensa','',''),(60,2,'Despensa','En esta sección podrá encontrar una gran variedad de artículos pensados para que llenes tu despensa.','despensa','',''),(64,1,'fruit','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','fruit','',''),(59,2,'Huerta','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','huerta','',''),(61,1,'carne','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','carne','',''),(61,2,'Carne','&lt;p&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;br&gt;&lt;/p&gt;','carne','',''),(62,1,'bebida','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','bebida','',''),(62,2,'Bebida','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','bebida','',''),(65,1,'Vegetables','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','vegetables','',''),(65,2,'Verdura','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Verdura','',''),(66,1,'oil','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','oil','',''),(66,2,'Aceite','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','aceite','',''),(67,1,'Elaborados','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','elaborados','',''),(67,2,'Elaborados','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Elaborados','',''),(72,1,'Wine','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','wine','',''),(68,1,'Cheese','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','cheese','',''),(68,2,'Queso','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Queso','',''),(69,1,'Pasta','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','pasta','',''),(69,2,'Pasta','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','pasta','',''),(70,1,'Dulce','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Dulce','',''),(70,2,'Dulce','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','dulce','',''),(71,1,'Beer','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Beer','',''),(71,2,'Cerveza','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','cerveza','',''),(72,2,'Vino','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','vino','',''),(59,1,'Huerta','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','huerta','','');
...
INSERT INTO `oc_category_path` VALUES (61,61,0),(60,60,0),(72,62,0),(71,71,1),(72,72,1),(70,70,1),(71,62,0),(69,69,1),(70,60,0),(68,60,0),(69,60,0),(67,67,1),(67,60,0),(68,68,1),(66,66,1),(66,60,0),(65,65,1),(65,59,0),(64,59,0),(64,64,1),(62,62,0),(59,59,0);
...
INSERT INTO `oc_category_to_layout` VALUES (59,0,0),(60,0,0),(61,0,0),(62,0,0),(64,0,0),(65,0,0),(66,0,0),(67,0,0),(68,0,0),(69,0,0),(70,0,0),(71,0,0),(72,0,0);
...
INSERT INTO `oc_category_to_store` VALUES (59,0),(60,0),(61,0),(62,0),(64,0),(65,0),(66,0),(67,0),(68,0),(69,0),(70,0),(71,0),(72,0);
...
INSERT INTO `oc_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.68599999,1,'2016-04-27 12:41:43'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2016-04-27 12:58:31'),(3,'Euro','EUR','','€','2',0.88330001,1,'2016-04-27 12:41:43');
...
INSERT INTO `oc_customer` VALUES (4,1,0,'victor','nunez','vnunez@visiona-ip.es','628718498','','a3642088bd7894928b9ce34770ed145462272038','NnkmdkGWu',NULL,NULL,1,4,'','127.0.0.1',1,1,0,'','2016-04-27 17:40:21'),(3,1,0,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','4e8a994fa51448414e0cdb290cd0db7af8e5b9c5','J7u8a13qn',NULL,NULL,1,3,'','127.0.0.1',1,1,0,'','2016-04-27 15:04:38'),(5,1,0,'victor','nunez','victor1@victor1.es','','','6723db10a60fd1dafc006e9e2e5fc4fc481ab4f8','u6Gu2EaGy',NULL,NULL,0,5,'','127.0.0.1',0,1,0,'','2016-04-27 23:39:44');
...
INSERT INTO `oc_customer_activity` VALUES (1,1,'register','{\"customer_id\":\"1\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-26 14:56:28'),(2,2,'register','{\"customer_id\":2,\"name\":\"victor nunez\"}','127.0.0.1','2016-04-27 14:32:34'),(3,3,'register','{\"customer_id\":3,\"name\":\"victor nunez\"}','127.0.0.1','2016-04-27 15:04:42'),(4,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-27 17:36:35'),(5,4,'register','{\"customer_id\":4,\"name\":\"victor nunez\"}','127.0.0.1','2016-04-27 17:40:25'),(6,4,'order_account','{\"customer_id\":\"4\",\"name\":\"victor nunez\",\"order_id\":1}','127.0.0.1','2016-04-27 17:53:53'),(7,4,'order_account','{\"customer_id\":\"4\",\"name\":\"victor nunez\",\"order_id\":2}','127.0.0.1','2016-04-27 18:35:41'),(8,5,'register','{\"customer_id\":\"5\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-27 23:39:50'),(9,5,'delete','{\"customer_id\":\"5\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 00:59:12'),(10,4,'login','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 01:25:41'),(11,4,'login','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 09:45:56'),(12,4,'address_add','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 09:50:33'),(13,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 11:40:58'),(14,4,'login','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 12:14:25'),(15,4,'login','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 15:00:34'),(16,4,'edit','{\"customer_id\":\"4\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-28 15:53:51'),(17,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-29 12:51:54'),(18,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-29 12:56:59'),(19,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-29 13:02:10'),(20,3,'login','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-29 13:10:19'),(21,3,'edit','{\"customer_id\":\"3\",\"name\":\"victor nunez\"}','127.0.0.1','2016-04-29 13:10:42'),(22,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-04-29 14:36:11'),(23,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-04-29 14:47:04'),(24,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-04-29 14:51:10'),(25,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-04-29 16:19:07'),(26,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-05-12 09:26:59'),(27,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-05-12 10:52:48'),(28,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-05-25 12:27:01'),(29,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-05-25 16:00:23'),(30,3,'login','{\"customer_id\":\"3\",\"name\":\"V\\u00edctor Nu\\u00f1ez\"}','127.0.0.1','2016-06-02 17:09:18');
...
INSERT INTO `oc_customer_ip` VALUES (3,3,'127.0.0.1','2016-04-27 15:04:43'),(4,4,'127.0.0.1','2016-04-27 17:40:25'),(5,5,'127.0.0.1','2016-04-27 23:39:50');
...
INSERT INTO `oc_customer_login` VALUES (1,'visiona1@visiona-ip.es','127.0.0.1',1,'2016-04-28 07:45:29','2016-04-28 07:45:29'),(2,'vnunmar@visiona-ip.es','127.0.0.1',2,'2016-04-28 07:45:40','2016-04-28 07:45:47'),(3,'admin','127.0.0.1',7,'2016-04-29 10:52:32','2016-06-06 08:04:26'),(4,'vnunmar@','127.0.0.1',1,'2016-06-02 15:09:11','2016-06-02 15:09:11');
...
INSERT INTO `oc_customer_wishlist` VALUES (1,43,'2016-04-26 14:59:55'),(3,50,'2016-04-29 16:19:31'),(3,53,'2016-04-29 16:19:24'),(3,51,'2016-04-29 16:19:28'),(3,52,'2016-04-29 16:19:18');
...
INSERT INTO `oc_event` VALUES (1,'voucher','post.order.history.add','total/voucher/send'),(2,'pp_login','post.customer.logout','module/pp_login/logout'),(3,'amazon_login','post.customer.logout','module/amazon_login/logout');
...
INSERT INTO `oc_extension` VALUES (2,'total','shipping'),(3,'total','sub_total'),(4,'total','tax'),(5,'total','total'),(6,'module','banner'),(7,'module','carousel'),(8,'total','credit'),(9,'shipping','flat'),(10,'total','handling'),(11,'total','low_order_fee'),(12,'total','coupon'),(13,'module','category'),(14,'module','account'),(15,'total','reward'),(16,'total','voucher'),(41,'module','html'),(18,'module','featured'),(19,'module','slideshow'),(30,'module','multimerch_shipping'),(27,'module','multiseller'),(28,'module','multimerch'),(29,'module','multimerch_newsellers'),(31,'module','multimerch_topsellers'),(32,'payment','advertikon_stripe'),(37,'module','pp_login'),(38,'module','amazon_login'),(39,'shipping','free'),(40,'total','ms_shipping'),(42,'shipping','weight');
...
INSERT INTO `oc_geo_zone` VALUES (5,'España','península ibérica a excepción de Canarias y Baleares','0000-00-00 00:00:00','2016-04-27 18:05:38'),(6,'Madrid','Dentro de la comunidad de madrid','0000-00-00 00:00:00','2016-04-27 18:06:28');
...
INSERT INTO `oc_information_description` VALUES (5,2,'Términos y Condiciones','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Términos y Condiciones','',''),(6,2,'Información de entrega','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','información de entrega','',''),(4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','about us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','',''),(4,2,'Sobre Nosotros','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','nosotros','',''),(3,2,'Política de privacidad','	\r\n	\r\n	\r\n\r\n\r\n&lt;h4 style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; line-height: 100%; font-family: Arial; color: inherit;&quot;&gt;VISIONA\r\nINGENIERÍA DE PROYECTOS S.L. informa a los Usuarios del Sitio Web\r\nsobre su política respecto del tratamiento y protección de los\r\ndatos de carácter personal de los usuarios y clientes que puedan ser\r\nrecabados por la navegación o contratación de servicios a través\r\nde Qfresh.co. VISIONA INGENIERÍA DE PROYECTOS S.L. garantiza el\r\ncumplimiento de la normativa vigente en materia de protección de\r\ndatos personales, reflejada en la Ley Orgánica 15/1999 de 13 de\r\ndiciembre, de Protección de Datos de Carácter Personal y en el Real\r\nDecreto 1720/2007, de 21 diciembre, por el que se aprueba el\r\nReglamento de Desarrollo de la LOPD.&lt;/span&gt;&lt;/div&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-family: Arial; font-size: 12pt; color: inherit; line-height: 100%;&quot;&gt;Asimismo,\r\nVISIONA INGENIERIA DE PROYECTOS S.L.U. ha adoptado las medidas de\r\níndole técnica y organizativa necesaria para garantizar la\r\nseguridad de los datos de carácter personal, y evitar su alteración,\r\npérdida, tratamiento o acceso no autorizado, teniendo en cuenta el\r\nestado de la tecnología, la naturaleza de los datos almacenados y\r\nlos riesgos a que están expuestos.&lt;/span&gt;&lt;/div&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; color: inherit; line-height: 100%;&quot;&gt;Sin\r\nembargo, es necesario tener en cuenta que la seguridad perfecta no\r\nexiste en Internet. Por ello, QFRESH.CO no se hace responsable por\r\ninterceptaciones ilegales o violación de sus sistemas o bases de\r\ndatos por parte de personas no autorizadas, ni tampoco se hace\r\nresponsable por la indebida utilización de la información obtenida\r\npor esos medios.&lt;/span&gt;&lt;/div&gt;&lt;/font&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; color: inherit; line-height: 100%;&quot;&gt;El\r\nacceso y utilización del Sitio Web implica la aceptación de esta\r\nPolítica de Privacidad.&lt;/span&gt;&lt;/div&gt;&lt;/font&gt;&lt;/span&gt;&lt;/h4&gt;&lt;h3 style=&quot;text-align: justify;&quot;&gt;&lt;font face=&quot;Times New Roman, serif&quot;&gt;&lt;font style=&quot;font-size: 20pt;&quot;&gt;&lt;b style=&quot;color: inherit;&quot;&gt;RECOGIDA,\r\nFINALIDAD Y TRATAMIENTO DE DATOS &lt;/b&gt;&lt;/font&gt;&lt;/font&gt;&lt;/h3&gt;\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h4 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;font-family: Arial; color: inherit;&quot;&gt;&lt;font style=&quot;font-size: 12pt;&quot;&gt;VISIONA\r\nINGENIERÍA DE PROYECTOS S.L. informa a los Usuarios de Qfresh.co\r\nacerca de la recogida de datos de carácter personal que pueden\r\nllevarse a cabo, bien sea mediante el envío de correo electrónico o\r\nal cumplimentar los formularios incluidos en el Sitio Web. VISIONA\r\nINGENIERÍA DE PROYECTOS S.L. seráconsiderada como responsable de\r\nlos datos recabados mediante los medios anteriormente descritos.&lt;br&gt; &lt;/font&gt;&lt;/span&gt;&lt;/h4&gt;&lt;h4&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;font style=&quot;font-family: Arial; color: inherit; font-size: 12pt;&quot;&gt;QFRESH.CO\r\npodrá eventualmente hacer uso de cookies, o recoger y almacenar\r\nautomáticamente información sobre la actividad de los usuarios\r\ndentro de nuestro sitio web, incluyendo dirección IP, la URL de\r\nprocedencia &lt;/font&gt;&lt;font style=&quot;font-family: Arial; color: inherit; font-size: 12pt;&quot;&gt;(estén\r\no no en nuestro sitio web)&lt;/font&gt;&lt;font style=&quot;font-family: Arial; color: inherit; font-size: 12pt;&quot;&gt;,\r\nURL consecutiva &lt;/font&gt;&lt;font style=&quot;font-family: Arial; color: inherit; font-size: 12pt;&quot;&gt;(estén\r\no no en nuestro sitio web)&lt;/font&gt;&lt;font style=&quot;font-family: Arial; color: inherit; font-size: 12pt;&quot;&gt;,\r\nnavegador usado, páginas visitadas, búsquedas, publicaciones,\r\ncompras o ventas, mensajes, etc.La recolección de esta información\r\nnos permite ofrecer servicios y funcionalidades que mejoren nuestro\r\nservicio y productos ofrecidos.&lt;/font&gt;&lt;/div&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; font-family: Arial; color: inherit; line-height: 1.1;&quot;&gt;A\r\nsu vez VISIONA INGENIERÍA DE PROYECTOS S.L. informa a los Usuarios\r\nde que la finalidad del tratamiento de los datos recabados contempla:\r\nla atención de solicitudes realizadas por los usuarios, la inclusión\r\nen la agenda de contactos, la prestación de los servicios, la\r\ngestión de la relación comercial y de pago, y el ofrecimiento de\r\nproductos y ofertas comerciales.&lt;/span&gt;&lt;/div&gt;&lt;span style=&quot;font-family: Arial;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; color: inherit; line-height: 1.1;&quot;&gt;Las\r\noperaciones, gestiones y procedimientos técnicos que se realicen de\r\nforma automatizada o no automatizada y que posibiliten la recogida,\r\nel almacenamiento, la modificación, la transferencia y otras\r\nacciones sobre datos de carácter personal, tienen la consideración\r\nde tratamiento de datos personales.&lt;/span&gt;&lt;/div&gt;&lt;/span&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; color: inherit; line-height: 1.1;&quot;&gt;Todos\r\nlos datos personales, que sean recogidos a través de Qfresh.co, y\r\npor tanto tengan la consideración de tratamiento de datos de\r\ncarácter personal, serán incorporados en los ficheros inscritos en\r\nel Registro General de Protección de Datos ante la Agencia Española\r\nde Protección de Datos por VISIONA INGENIERÍA DE PROYECTOS S.L.&lt;/span&gt;&lt;/div&gt;&lt;/font&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; color: inherit; line-height: 1.1;&quot;&gt;Para\r\nque la información que contienen los ficheros esté siempre\r\nactualizada y no contenga errores, solicitamos a los Usuarios que\r\ncomuniquen a VISIONA INGENIERÍA DE PROYECTOS S.L., a la mayor\r\nbrevedad posible, las modificaciones y rectificaciones de sus datos\r\nde carácter personal. Los Usuarios son responsables de la veracidad\r\nde los datos suministrados.&lt;/span&gt;&lt;/div&gt;&lt;/font&gt;&lt;/span&gt;&lt;/h4&gt;\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h3 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;font face=&quot;Times New Roman, serif&quot;&gt;&lt;font style=&quot;font-size: 20pt;&quot;&gt;&lt;b style=&quot;color: inherit;&quot;&gt;CONSENTIMIENTO&lt;/b&gt;&lt;/font&gt;&lt;/font&gt;&lt;/h3&gt;\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h4 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial; color: inherit;&quot;&gt;La\r\ncumplimentación del formulario incluido en Qfresh.co o el envío de\r\ncorreos electrónicos u otras comunicaciones a VISIONA INGENIERIA DE\r\nPROYECTOS S.L., implica el consentimiento expreso del Usuario a la\r\ninclusión de sus datos de carácter personal en los ficheros\r\ntitularidad de VISIONA INGENIERIA DE PROYECTOS S.L..&lt;/font&gt;&lt;/h4&gt;\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h3 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;font face=&quot;Times New Roman, serif&quot;&gt;&lt;font style=&quot;font-size: 20pt;&quot;&gt;&lt;b style=&quot;color: inherit;&quot;&gt;COMUNICACIÓN\r\nDE INFORMACIÓN A TERCEROS&lt;/b&gt;&lt;/font&gt;&lt;/font&gt;&lt;/h3&gt;\r\n&lt;p style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h4 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;font-family: Arial; color: inherit;&quot;&gt;&lt;font style=&quot;font-size: 12pt;&quot;&gt;VISIONA\r\nINGENIERÍA DE PROYECTOS S.L. informa a los Usuarios de que sus datos\r\npersonales no serán cedidos a terceras organizaciones, con la\r\nsalvedad de que dicha cesión de datos esté amparada en una\r\nobligación legal,o cuando lo requiera la mejor prestación de un\r\nservicio&lt;/font&gt;&lt;font style=&quot;font-size: 6pt&quot;&gt;&lt;span style=&quot;background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;&quot;&gt;.&lt;br&gt;&lt;/span&gt;&lt;/font&gt;&lt;/span&gt;&lt;/h4&gt;&lt;h4 style=&quot;text-align: justify;&quot;&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial; color: inherit;&quot;&gt;En\r\neste último caso, sólo se llevará a cabo la cesión de datos al\r\ntercero cuandoVISIONA INGENIERÍA DE PROYECTOS S.L disponga del\r\nconsentimiento expreso del Usuario, salvo que la cesión responda a\r\nla libre y legítima aceptación de una relación jurídica cuyo\r\ndesarrollo, cumplimiento y control comporte la comunicación de\r\ndatos. &lt;/font&gt;&lt;/h4&gt;\r\n\r\n&lt;h3 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;&lt;/span&gt;&lt;/h3&gt;&lt;h3 style=&quot;text-align: justify;&quot;&gt;&lt;font face=&quot;Times New Roman, serif&quot;&gt;&lt;font style=&quot;font-size: 20pt;&quot;&gt;&lt;b style=&quot;color: inherit;&quot;&gt;DERECHOS\r\nDE LOS USUARIOS &lt;/b&gt;&lt;/font&gt;&lt;/font&gt;&lt;/h3&gt;\r\n\r\n&lt;p style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h4 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;span style=&quot;font-family: Arial;&quot;&gt;&lt;font style=&quot;font-size: 12pt;&quot;&gt;Los\r\nUsuarios podrán ejercer los derechos de acceso, rectificación,\r\ncancelación y oposición de acuerdo con lo previsto en la normativa\r\nlegal vigente en materia de protección de datos personales. Asimismo\r\npodrán revocar el consentimiento prestado a la recepción de\r\ncomunicaciones comerciales conforme a lo previsto en la Ley de\r\nServicios de la Sociedad de la Información y del Comercio\r\nElectrónico.&lt;/font&gt;&lt;/span&gt;&lt;span style=&quot;font-family: Arial;&quot;&gt;&lt;br&gt;&lt;/span&gt;&lt;/span&gt;&lt;/h4&gt;&lt;h4&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-size: 12pt; font-family: Arial; color: inherit; line-height: 1.1;&quot;&gt;Para\r\nhacer uso del ejercicio de estos derechos, el Usuario deberá\r\ndirigirse mediante comunicación escrita, aportando documentación\r\nque acredite su identidad (DNI o pasaporte), a la siguiente\r\ndirección: VISIONA INGENIERÍA DE PROYECTOS S.L, C/ Copenhague 8,\r\nlocal 110, 28232, Las Rozas, Madrid o a la cuenta de correo:\r\ninfo@qfresh.co&lt;/span&gt;&lt;/div&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;div style=&quot;text-align: justify;&quot;&gt;&lt;span style=&quot;font-family: Arial; font-size: 12pt; color: inherit; line-height: 1.1;&quot;&gt;Dicha\r\ncomunicación deberá reflejar la siguiente información: Nombre y\r\napellidos del Usuario, la petición de solicitud, el domicilio y los\r\ndatos acreditativos. El ejercicio de derechos deberá ser realizado\r\npor el propio Usuario. No obstante, podrán ser ejecutados por una\r\npersona autorizada como representante legal del autorizado. En tal\r\ncaso, se deberá aportar la documentación que acredite esta\r\nrepresentación del interesado.&lt;/span&gt;&lt;/div&gt;&lt;/span&gt;&lt;/h4&gt;\r\n\r\n\r\n\r\n\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h3 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;font face=&quot;Times New Roman, serif&quot;&gt;&lt;font style=&quot;font-size: 20pt;&quot;&gt;&lt;b style=&quot;color: inherit;&quot;&gt;CAMBIOS\r\nEN LA POLÍTICA DE PRIVACIDAD&lt;/b&gt;&lt;/font&gt;&lt;/font&gt;&lt;/h3&gt;\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;span style=&quot;color: inherit;&quot;&gt;&lt;br&gt;\r\n&lt;/span&gt;&lt;/p&gt;\r\n&lt;h4 style=&quot;text-align: justify; margin-bottom: 0cm; line-height: 100%;&quot;&gt;&lt;font style=&quot;font-size: 12pt; font-family: Arial; color: inherit;&quot;&gt;VISIONA\r\nINGENIERIA DE PROYECTOS S.L.U. se reserva el derecho de modificar su\r\nPolítica de Privacidad con el objeto de adaptarlo a las novedades\r\nlegislativas o jurisprudenciales, así como las que pudieran\r\nderivarse de decisiones corporativas estratégicas, con efectos desde\r\nla fecha de publicación de dicha modificación en el Sitio Web.&lt;/font&gt;&lt;/h4&gt;\r\n&lt;p align=&quot;justify&quot; style=&quot;margin-bottom: 0cm; line-height: 100%&quot;&gt;&lt;br&gt;\r\n&lt;/p&gt;&lt;p style=&quot;margin-bottom: 0.35cm; line-height: 115%&quot;&gt;&lt;/p&gt;','Política de privacidad','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','','');
...
INSERT INTO `oc_language` VALUES (1,'English','en','en_US.UTF-8,en_US,en-gb,english','gb.png','english',2,1),(2,'Español','es','es_ES.UTF-8,es_ES,es-es,es_es,español','es.png','spanish',1,1);
...
INSERT INTO `oc_layout` VALUES (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search'),(14,'[MultiMerch] Seller Account Pages'),(15,'[MultiMerch] Sellers List'),(16,'[MultiMerch] Seller Profile Page'),(17,'[MultiMerch] Seller Products List'),(18,'[MultiMerch] Seller Account Pages'),(19,'[MultiMerch] Sellers List'),(20,'[MultiMerch] Seller Profile Page'),(21,'[MultiMerch] Seller Products List'),(22,'Pav Blog');
...
INSERT INTO `oc_layout_module` VALUES (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'affiliate','column_right',1),(68,6,'account','column_right',1),(122,3,'category','column_left',1),(121,1,'featured.28','content_top',5),(120,1,'html.32','content_top',4),(119,1,'html.33','content_top',2),(118,1,'html.34','content_top',6),(117,1,'slideshow.27','content_top',0),(116,1,'html.35','content_top',8);
...
INSERT INTO `oc_layout_route` VALUES (38,6,0,'account/%'),(17,10,0,'affiliate/%'),(74,3,0,'product/category'),(73,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(23,7,0,'checkout/%'),(31,8,0,'information/contact'),(32,9,0,'information/sitemap'),(34,4,0,''),(45,5,0,'product/manufacturer'),(52,12,0,'product/compare'),(53,13,0,'product/search'),(60,20,0,'seller/catalog-seller/profile'),(59,19,0,'seller/catalog-seller'),(58,18,0,'seller/account-%'),(61,21,0,'seller/catalog-seller/products'),(62,22,0,'pavblog/');
...
INSERT INTO `oc_length_class` VALUES (1,1.00000000),(2,10.00000000);
...
INSERT INTO `oc_length_class_description` VALUES (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(1,2,'Centímetro','cm'),(2,2,'Milímetro','mm');
...
INSERT INTO `oc_megamenu` VALUES (45,'',1,0,'','','','','25','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(46,'',1,0,'','','','','57','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(47,'',1,0,'','','','','34','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(48,'',1,0,'','','','','59','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(49,'',1,0,'','','','','17','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(50,'',1,0,'','','','','18','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(51,'',1,0,'','','','','20','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(52,'',1,0,'','','','','24','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(53,'',50,0,'','','','','46','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(54,'',50,0,'','','','','45','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(55,'',51,0,'','','','','27','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(56,'',51,0,'','','','','26','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(57,'',45,0,'','','','','32','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(58,'',45,0,'','','','','28','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(59,'',45,0,'','','','','29','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(60,'',45,0,'','','','','30','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(61,'',45,0,'','','','','31','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(62,'',58,0,'','','','','36','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(63,'',58,0,'','','','','35','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(64,'',47,0,'','','','','50','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(65,'',47,0,'','','','','51','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(66,'',47,0,'','','','','52','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(67,'',47,0,'','','','','53','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(68,'',47,0,'','','','','54','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(69,'',47,0,'','','','','55','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(70,'',47,0,'','','','','56','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(71,'',47,0,'','','','','49','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(72,'',47,0,'','','','','48','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(73,'',47,0,'','','','','47','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(74,'',47,0,'','','','','37','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(75,'',47,0,'','','','','38','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(76,'',47,0,'','','','','39','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(77,'',47,0,'','','','','40','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(78,'',47,0,'','','','','41','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(79,'',47,0,'','','','','42','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(80,'',47,0,'','','','','43','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(81,'',47,0,'','','','','44','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(82,'',66,0,'','','','','58','1','category',2,1,'menu',0,1,1,99,0,'','',0,'top','','','','',0,0,0,1,''),(272,'',1,0,NULL,NULL,NULL,'','97','1','category',0,1,'menu',0,1,0,4,0,'',NULL,0,'top','',NULL,'','&lt;p&gt;&lt;br&gt;&lt;/p&gt;',0,0,0,1,''),(273,'',1,0,NULL,NULL,NULL,NULL,'88','1','category',2,1,'menu',0,1,0,2,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(274,'',1,0,NULL,NULL,NULL,NULL,'94','1','category',2,1,'menu',0,1,0,3,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(275,'',1,0,NULL,NULL,NULL,NULL,'85','1','category',2,1,'menu',0,1,0,1,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(276,'',275,0,NULL,NULL,NULL,NULL,'87','1','category',2,1,'menu',0,1,0,1,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(277,'',275,0,NULL,NULL,NULL,NULL,'86','1','category',2,1,'menu',0,1,0,2,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(278,'',273,0,NULL,NULL,NULL,NULL,'89','1','category',2,1,'menu',0,1,0,1,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(279,'',273,0,NULL,NULL,NULL,NULL,'90','1','category',2,1,'menu',0,1,0,2,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(280,'',273,0,NULL,NULL,NULL,NULL,'91','1','category',2,1,'menu',0,1,0,3,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(281,'',273,0,NULL,NULL,NULL,NULL,'92','1','category',2,1,'menu',0,1,0,4,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(282,'',273,0,NULL,NULL,NULL,NULL,'93','1','category',2,1,'menu',0,1,0,5,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(283,'',274,0,NULL,NULL,NULL,NULL,'95','1','category',2,1,'menu',0,1,0,1,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(284,'',274,0,NULL,NULL,NULL,NULL,'96','1','category',2,1,'menu',0,1,0,2,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,0,0,0,1,NULL),(285,'',1,0,NULL,NULL,NULL,'','','1','url',0,1,'menu',0,1,0,99,0,'../../../../../index.php?route=seller/catalog-seller',NULL,0,'top','',NULL,'','&lt;p&gt;&lt;br&gt;&lt;/p&gt;',0,0,0,1,'');
...
INSERT INTO `oc_module` VALUES (30,'Category','banner','{\"name\":\"Category\",\"banner_id\":\"8\",\"width\":\"202\",\"height\":\"202\",\"status\":\"1\"}'),(29,'Home Page','carousel','{\"name\":\"Home Page\",\"banner_id\":\"8\",\"width\":\"1024\",\"height\":\"346\",\"status\":\"1\"}'),(28,'Destacado Despensa','featured','{\"name\":\"Destacado Despensa\",\"product\":[\"50\",\"51\",\"52\",\"53\"],\"limit\":\"4\",\"width\":\"200\",\"height\":\"200\",\"status\":\"1\"}'),(27,'Home Page','slideshow','{\"name\":\"Home Page\",\"banner_id\":\"7\",\"width\":\"2048\",\"height\":\"700\",\"status\":\"1\"}'),(31,'Banner 1','banner','{\"name\":\"Banner 1\",\"banner_id\":\"7\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}'),(32,'Destacado Despensa','html','{\"name\":\"Destacado Despensa\",\"module_description\":{\"2\":{\"title\":\"\",\"description\":\"&lt;h2&gt;&lt;a href=&quot;\\/index.php?route=product\\/category&amp;amp;path=60&quot;&gt;&lt;img style=&quot;float: none; width: 100%; height: auto;&quot; src=&quot;\\/image\\/catalog\\/destacadosDespensa.png&quot;&gt;&lt;\\/a&gt;&lt;\\/h2&gt;\"},\"1\":{\"title\":\"\",\"description\":\"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;\"}},\"status\":\"1\"}'),(33,'Destacados Huerta','html','{\"name\":\"Destacados Huerta\",\"module_description\":{\"2\":{\"title\":\"\",\"description\":\"&lt;h2&gt;&lt;a href=&quot;\\/index.php?route=product\\/category&amp;amp;path=59&quot;&gt;&lt;img style=&quot;float: none; width: 100%; height: auto;&quot; src=&quot;\\/image\\/catalog\\/destacadosHuerta.png&quot;&gt;&lt;\\/a&gt;&lt;\\/h2&gt;\"},\"1\":{\"title\":\"\",\"description\":\"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;\"}},\"status\":\"1\"}'),(34,'Destacados bebida','html','{\"name\":\"Destacados bebida\",\"module_description\":{\"2\":{\"title\":\"\",\"description\":\"&lt;h2&gt;&lt;a href=&quot;\\/index.php?route=product\\/category&amp;amp;path=62&quot;&gt;&lt;img style=&quot;float: none; width: 100%; height: auto;&quot; src=&quot;\\/image\\/catalog\\/destacadosBebida.png&quot;&gt;&lt;\\/a&gt;&lt;\\/h2&gt;\"},\"1\":{\"title\":\"\",\"description\":\"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;\"}},\"status\":\"1\"}'),(35,'Destacados Carne','html','{\"name\":\"Destacados Carne\",\"module_description\":{\"2\":{\"title\":\"\",\"description\":\"&lt;h2&gt;&lt;a href=&quot;\\/index.php?route=product\\/category&amp;amp;path=61&quot;&gt;&lt;img style=&quot;float: none; width: 100%; height: auto;&quot; src=&quot;\\/image\\/catalog\\/destacadosCarne.png&quot;&gt;&lt;\\/a&gt;&lt;\\/h2&gt;\"},\"1\":{\"title\":\"\",\"description\":\"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;\"}},\"status\":\"1\"}');
...
INSERT INTO `oc_ms_attribute` VALUES (1,7,0,0,0,1,1,1);
...
INSERT INTO `oc_ms_attribute_attribute` VALUES (1,12);
...
INSERT INTO `oc_ms_attribute_description` VALUES (1,1,'unit','unit'),(1,2,'Unidad de medida','Unidad de medida del producto');
...
INSERT INTO `oc_ms_attribute_value` VALUES (1,1,'',1),(2,1,'',0),(3,1,'',0),(4,1,'',0);
...
INSERT INTO `oc_ms_attribute_value_description` VALUES (1,1,1,'kg'),(1,2,1,'Kg'),(2,1,1,'L'),(2,2,1,'L'),(3,1,1,'Ud'),(3,2,1,'Ud'),(4,1,1,'Pack'),(4,2,1,'Pack');
...
INSERT INTO `oc_ms_balance` VALUES (1,4,6,51,NULL,NULL,20,4.4200,4.4200,'Shipping cost for order 6, seller victor','2016-04-28 13:40:11',NULL),(2,4,6,51,8,NULL,1,0.0000,4.4200,'Oferta: 4 x Aceite de limón y ajo (-0.00€ comisión)','2016-04-28 13:40:11',NULL),(3,4,6,51,9,NULL,1,0.0000,4.4200,'Oferta: 4 x Aceite de limón y ajo (-0.00€ comisión)','2016-04-28 13:40:36',NULL),(4,4,8,50,NULL,NULL,20,4.4200,8.8400,'Shipping cost for order 8, seller victor','2016-04-29 16:24:15',NULL),(5,4,8,50,14,NULL,1,41.6900,50.5300,'Oferta: 8 x Aceite de chile (-0.00€ comisión)','2016-04-29 16:24:15',NULL),(6,4,8,51,15,NULL,1,35.1600,85.6900,'Oferta: 4 x Aceite de limón y ajo (-0.00€ comisión)','2016-04-29 16:24:15',NULL),(7,4,8,52,16,NULL,1,35.1600,120.8500,'Oferta: 4 x Aceite de Romero (-0.00€ comisión)','2016-04-29 16:24:15',NULL),(8,4,11,51,NULL,NULL,20,4.4200,125.2700,'Shipping cost for order 11, seller victor','2016-06-06 10:59:26',NULL),(9,4,11,51,42,NULL,1,0.0000,125.2700,'Oferta: 4 x Aceite aromático de limón y ajo (-0.00€ comisión)','2016-06-06 10:59:26',NULL),(10,4,11,50,41,NULL,1,0.0000,125.2700,'Oferta: 12 x Aceite aromático de chile (-0.00€ comisión)','2016-06-06 10:59:26',NULL),(11,4,11,52,43,NULL,1,0.0000,125.2700,'Oferta: 4 x Aceite aromático de Romero (-0.00€ comisión)','2016-06-06 10:59:26',NULL),(12,4,11,51,45,NULL,1,0.0000,125.2700,'Oferta: 4 x Aceite aromático de limón y ajo (-0.00€ comisión)','2016-06-06 10:59:58',NULL),(13,4,11,52,46,NULL,1,0.0000,125.2700,'Oferta: 4 x Aceite aromático de Romero (-0.00€ comisión)','2016-06-06 10:59:58',NULL),(14,4,11,50,44,NULL,1,0.0000,125.2700,'Oferta: 12 x Aceite aromático de chile (-0.00€ comisión)','2016-06-06 10:59:58',NULL);
...
INSERT INTO `oc_ms_channel` VALUES (1,'catalog/multimerch/social_links/GraphicBurger/Facebook.png'),(2,'catalog/multimerch/social_links/GraphicBurger/Twitter.png'),(3,'catalog/multimerch/social_links/GraphicBurger/LinkedIn.png'),(4,'catalog/multimerch/social_links/GraphicBurger/Google+.png'),(5,'catalog/multimerch/social_links/GraphicBurger/Facebook.png');
...
INSERT INTO `oc_ms_channel_description` VALUES (1,1,'Facebook','Please specify your Facebook link'),(1,2,'Facebook','Please specify your Facebook link'),(2,1,'Twitter','Please specify your Twitter link'),(2,2,'Twitter','Please specify your Twitter link'),(3,1,'LinkedIn','Please specify your LinkedIn link'),(3,2,'LinkedIn','Please specify your LinkedIn link'),(4,1,'Google+','Please specify your Google+ link'),(4,2,'Google+','Please specify your Google+ link'),(5,1,'Facebook',''),(5,2,'Facebook','Facebook.com/qfreshco');
...
INSERT INTO `oc_ms_commission` VALUES (1);
...
INSERT INTO `oc_ms_commission_rate` VALUES (1,1,1,0.0000,0.00,1),(2,3,1,0.0000,0.00,1),(3,2,1,0.0000,0.00,1);
...
INSERT INTO `oc_ms_conversation` VALUES (1,52,NULL,'Pregunta sobre el producto: Aceite aromático de Romero','2016-06-02 17:09:39'),(2,52,NULL,'Pregunta sobre el producto: Aceite aromático de Romero','2016-06-02 17:09:42'),(3,52,NULL,'Pregunta sobre el producto: Aceite aromático de Romero','2016-06-02 17:10:00');
...
INSERT INTO `oc_ms_db_schema` VALUES (1,1,0,3,2,'2016-04-26 16:51:30'),(2,1,0,3,2,'2016-04-27 13:01:50');
...
INSERT INTO `oc_ms_message` VALUES (1,1,3,4,'holaaaa',0,'2016-06-02 17:09:39'),(2,2,3,4,'holaaaa',0,'2016-06-02 17:09:42'),(3,3,3,4,'holaaaa',0,'2016-06-02 17:10:00');
...
INSERT INTO `oc_ms_order_product_data` VALUES (1,1,50,1,4,0.0000,0.0000,19.9000),(2,2,51,2,4,0.0000,0.0000,19.9000),(3,3,50,3,4,0.0000,0.0000,19.9000),(4,3,51,4,4,0.0000,0.0000,19.9000),(5,4,51,5,4,0.0000,0.0000,39.8000),(6,5,51,6,4,0.0000,0.0000,39.8000),(7,6,51,7,4,0.0000,0.0000,39.8000),(8,7,54,10,4,0.0000,0.0000,44.8950),(9,7,56,11,4,0.0000,0.0000,175.1200),(10,7,56,12,4,0.0000,0.0000,175.1200),(11,7,56,13,4,0.0000,0.0000,175.1200),(12,8,50,14,4,0.0000,0.0000,47.2000),(13,8,51,15,4,0.0000,0.0000,39.8000),(14,8,52,16,4,0.0000,0.0000,39.8000),(15,9,50,17,4,0.0000,0.0000,119.4000),(16,9,51,18,4,0.0000,0.0000,39.8000),(17,9,52,19,4,0.0000,0.0000,39.8000),(18,10,50,20,4,0.0000,0.0000,119.4000),(19,10,51,21,4,0.0000,0.0000,39.8000),(20,10,52,22,4,0.0000,0.0000,39.8000),(21,11,50,23,4,0.0000,0.0000,119.4000),(22,11,51,24,4,0.0000,0.0000,39.8000),(23,11,52,25,4,0.0000,0.0000,39.8000),(24,12,50,26,4,0.0000,0.0000,119.4000),(25,12,52,27,4,0.0000,0.0000,39.8000),(26,13,50,28,4,0.0000,0.0000,119.4000),(27,14,50,29,4,0.0000,0.0000,119.4000),(28,14,52,30,4,0.0000,0.0000,39.8000),(29,14,53,31,4,0.0000,0.0000,39.8000),(30,15,50,32,4,0.0000,0.0000,119.4000),(31,15,52,33,4,0.0000,0.0000,39.8000),(32,15,53,34,4,0.0000,0.0000,39.8000),(33,16,52,35,4,0.0000,0.0000,39.8000),(34,16,53,36,4,0.0000,0.0000,39.8000),(35,17,52,37,4,0.0000,0.0000,39.8000),(36,17,53,38,4,0.0000,0.0000,39.8000),(37,18,52,39,4,0.0000,0.0000,79.6000),(38,18,53,40,4,0.0000,0.0000,59.7000);
...
INSERT INTO `oc_ms_order_product_shippable` VALUES (1,1,2,51),(2,1,3,51),(3,1,4,51),(4,1,5,51),(5,1,6,51),(6,1,7,54),(7,1,7,56),(8,1,7,56),(9,1,7,56),(10,1,8,50),(11,1,8,51),(12,1,8,52),(13,1,9,50),(14,1,9,51),(15,1,9,52),(16,1,10,50),(17,1,10,51),(18,1,10,52),(19,1,11,50),(20,1,11,51),(21,1,11,52),(22,1,12,50),(23,1,12,52),(24,1,13,50),(25,1,14,50),(26,1,14,52),(27,1,14,53),(28,1,15,50),(29,1,15,52),(30,1,15,53),(31,1,16,52),(32,1,16,53),(33,1,17,52),(34,1,17,53),(35,1,18,52),(36,1,18,53);
...
INSERT INTO `oc_ms_order_seller_shipping` VALUES (1,'Horario de mañana',5.0000,2,4),(2,'Horario de mañana',5.0000,3,4),(3,'Horario de tarde',5.0000,4,4),(4,'Horario de mañana',5.0000,5,4),(5,'Horario de mañana',5.0000,6,4),(6,'Horario de tarde',5.0000,7,4),(7,'Horario de tarde',5.0000,7,4),(8,'Horario de tarde',5.0000,7,4),(9,'Horario de tarde',5.0000,7,4),(10,'Horario de mañana',5.0000,8,4),(11,'Horario de mañana',5.0000,8,4),(12,'Horario de mañana',5.0000,8,4),(13,'Horario de tarde (16 - 21h )',5.0000,9,4),(14,'Horario de tarde (16 - 21h )',5.0000,9,4),(15,'Horario de tarde (16 - 21h )',5.0000,9,4),(16,'Horario de mañana ( 9 - 13h )',5.0000,10,4),(17,'Horario de mañana ( 9 - 13h )',5.0000,10,4),(18,'Horario de mañana ( 9 - 13h )',5.0000,10,4),(19,'Horario de mañana ( 9 - 13h )',5.0000,11,4),(20,'Horario de mañana ( 9 - 13h )',5.0000,11,4),(21,'Horario de mañana ( 9 - 13h )',5.0000,11,4),(22,'Horario de mañana ( 9 - 13h )',5.0000,12,4),(23,'Horario de mañana ( 9 - 13h )',5.0000,12,4),(24,'Horario de mañana ( 9 - 13h )',5.0000,13,4),(25,'Horario de mañana ( 9 - 13h )',5.0000,14,4),(26,'Horario de mañana ( 9 - 13h )',5.0000,14,4),(27,'Horario de mañana ( 9 - 13h )',5.0000,14,4),(28,'Horario de mañana ( 9 - 13h )',5.0000,15,4),(29,'Horario de mañana ( 9 - 13h )',5.0000,15,4),(30,'Horario de mañana ( 9 - 13h )',5.0000,15,4),(31,'Horario de mañana ( 9 - 13h )',5.0000,16,4),(32,'Horario de mañana ( 9 - 13h )',5.0000,16,4),(33,'Horario de mañana ( 9 - 13h )',5.0000,17,4),(34,'Horario de mañana ( 9 - 13h )',5.0000,17,4),(35,'Horario de mañana ( 9 - 13h )',5.0000,18,4),(36,'Horario de mañana ( 9 - 13h )',5.0000,18,4);
...
INSERT INTO `oc_ms_order_shipping` VALUES (1,1,2,4),(2,1,3,4),(3,1,4,4),(4,1,5,4),(5,1,6,4),(6,1,7,4),(7,1,8,4),(8,1,9,4),(9,1,10,4),(10,1,11,4),(11,1,12,4),(12,1,13,4),(13,1,14,4),(14,1,15,4),(15,1,16,4),(16,1,17,4),(17,1,18,4);
...
INSERT INTO `oc_ms_product` VALUES (50,4,32,1,1,NULL),(51,4,20,1,1,NULL),(52,4,12,1,1,NULL),(53,4,0,1,1,NULL),(54,4,0,1,1,NULL),(55,4,0,1,1,NULL),(56,4,0,1,1,NULL);
...
INSERT INTO `oc_ms_product_attribute` VALUES (50,1,3),(51,1,3),(52,1,3),(53,1,3),(54,1,3),(55,1,3),(56,1,4);
...
INSERT INTO `oc_ms_product_shipping_method` VALUES (3,51,1,5,5.50000000,''),(4,51,2,6,4.50000000,'');
...
INSERT INTO `oc_ms_seller` VALUES (3,'Tienda de Victor','','','&lt;p&gt;tienda de prueba para el market de Qfresh.co&lt;/p&gt;',0,0,'sellers/3/Tienda.jpg','','','2016-04-27 15:06:55',1,1,1,1,NULL,0),(4,'Oleo Quirós','','','',0,0,'sellers/4/ART_OF_OIL_Logo_Black_2015_02.jpg','','','2016-04-27 17:43:07',1,1,1,1,NULL,1);
...
INSERT INTO `oc_ms_seller_group` VALUES (1,1,0,0);
...
INSERT INTO `oc_ms_seller_group_description` VALUES (1,1,'Default','Default seller group',1),(2,1,'Default','Default seller group',2);
...
INSERT INTO `oc_ms_seller_shipping_method` VALUES (7,4,3,5,1,200.0000,5.00000000,''),(8,4,4,5,1,200.0000,5.00000000,''),(9,4,3,6,1,200.0000,4.00000000,''),(10,4,4,6,1,200.0000,4.00000000,'');
/*!40000 ALTER TABLE `oc_ms_seller_shipping_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc_ms_setting`
--

DROP TABLE IF EXISTS `oc_ms_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ms_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `slr_id_name` (`seller_id`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oc_ms_setting`
--

LOCK TABLES `oc_ms_setting` WRITE;
/*!40000 ALTER TABLE `oc_ms_setting` DISABLE KEYS */;
INSERT INTO `oc_ms_setting` VALUES (1,4,1,'slr_full_name','Eliseo Población',NULL),(2,4,1,'slr_address_line1','',NULL),(3,4,1,'slr_address_line2','',NULL),(4,4,1,'slr_city','',NULL),(5,4,1,'slr_state','',NULL),(6,4,1,'slr_zip','',NULL),(7,4,1,'slr_country','244',NULL),(8,4,1,'slr_website','',NULL),(9,4,1,'slr_company','',NULL),(10,4,1,'slr_phone','',NULL);
/*!40000 ALTER TABLE `oc_ms_setting` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `oc_ms_shipping_method` VALUES (1),(2),(3),(4);
...
INSERT INTO `oc_ms_shipping_method_description` VALUES (1,1,'Default carrier','Default shipping carrier company (delete it)',1),(2,1,'Envío por defecto','Envío por defecto',2),(3,2,'shipping 2','shipping 2',1),(4,2,'Envío especial','Envío especial',2),(5,3,'Horario de mañana ( 9 - 13h )','',2),(6,3,'mañana','',1),(7,4,'Horario de tarde (16 - 21h )','',2),(8,4,'afternoon','',1);
...
INSERT INTO `oc_ms_suborder` VALUES (1,1,4,0),(2,2,4,0),(3,3,4,3),(4,4,4,5),(5,5,4,0),(6,6,4,0),(7,7,4,0),(8,8,4,0),(9,9,4,0),(10,10,4,0),(11,11,4,0),(12,12,4,0),(13,13,4,0),(14,14,4,0),(15,15,4,0),(16,16,4,0),(17,17,4,0),(18,18,4,0);
...
INSERT INTO `oc_ms_suborder_history` VALUES (1,1,0,'Pedido creado','2016-04-27 17:53:50'),(2,2,0,'Pedido creado','2016-04-27 18:35:10'),(3,3,0,'Pedido creado','2016-04-27 21:35:52'),(4,3,3,'el pedido ha sido entregado a la empresa de paquetería','2016-04-27 22:03:12'),(5,4,0,'Pedido creado','2016-04-27 22:06:49'),(6,5,0,'Pedido creado','2016-04-28 09:54:27'),(7,6,0,'Pedido creado','2016-04-28 11:41:45'),(8,4,5,'ya se ha entregado correctamente','2016-04-28 15:01:08'),(9,7,0,'Pedido creado','2016-04-28 17:54:44'),(10,8,0,'Pedido creado','2016-04-29 15:27:18'),(11,9,0,'Pedido creado','2016-05-25 12:29:24'),(12,10,0,'Pedido creado','2016-05-25 12:49:32'),(13,11,0,'Pedido creado','2016-05-25 16:00:51'),(14,12,0,'Pedido creado','2016-05-25 16:13:50'),(15,13,0,'Pedido creado','2016-05-25 16:22:38'),(16,14,0,'Pedido creado','2016-05-25 16:24:26'),(17,15,0,'Pedido creado','2016-05-25 16:24:41'),(18,16,0,'Pedido creado','2016-05-25 16:26:38'),(19,17,0,'Pedido creado','2016-05-25 16:51:48'),(20,18,0,'Pedido creado','2016-05-25 16:52:59');
/*!40000 ALTER TABLE `oc_ms_suborder_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc_mxt_db_schema`
--

DROP TABLE IF EXISTS `oc_mxt_db_schema`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_mxt_db_schema` (
  `schema_change_id` int(11) NOT NULL AUTO_INCREMENT,
  `major` tinyint(4) NOT NULL,
  `minor` tinyint(4) NOT NULL,
  `build` tinyint(4) NOT NULL,
...
--
-- Dumping data for table `oc_mxt_db_schema`
--

LOCK TABLES `oc_mxt_db_schema` WRITE;
/*!40000 ALTER TABLE `oc_mxt_db_schema` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc_mxt_db_schema` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `oc_option` VALUES (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11),(13,'select',1),(14,'select',2),(15,'select',3),(16,'select',4);
...
INSERT INTO `oc_option_description` VALUES (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size'),(1,2,'Radio'),(2,2,'Checkbox'),(4,2,'Text'),(6,2,'Textarea'),(8,2,'Date'),(7,2,'File'),(5,2,'Select'),(9,2,'Time'),(10,2,'Date &amp; Time'),(12,2,'Delivery Date'),(11,2,'Size'),(13,2,'Botella aceite aromático 1'),(13,1,'oil'),(14,2,'Botella aceite aromático 2'),(14,1,'oil'),(15,2,'Botella aceite aromático 3'),(15,1,'oil'),(16,2,'Botella aceite aromático 4'),(16,1,'oil');
...
INSERT INTO `oc_option_value` VALUES (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3),(49,13,'',1),(54,13,'',0),(53,13,'',0),(52,13,'',0),(51,13,'',0),(50,13,'',0),(55,14,'',0),(56,14,'',0),(57,14,'',0),(58,14,'',0),(59,14,'',0),(60,14,'',0),(61,15,'',0),(62,15,'',0),(63,15,'',0),(64,15,'',0),(65,15,'',0),(66,15,'',0),(67,16,'',0),(68,16,'',0),(69,16,'',0),(70,16,'',0),(71,16,'',0),(72,16,'',0);
...
INSERT INTO `oc_option_value_description` VALUES (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small'),(43,2,1,'Large'),(32,2,1,'Small'),(45,2,2,'Checkbox 4'),(44,2,2,'Checkbox 3'),(31,2,1,'Medium'),(42,2,5,'Yellow'),(41,2,5,'Green'),(39,2,5,'Red'),(40,2,5,'Blue'),(23,2,2,'Checkbox 1'),(24,2,2,'Checkbox 2'),(48,2,11,'Large'),(47,2,11,'Medium'),(46,2,11,'Small'),(54,2,13,'Romero'),(53,1,13,'Lemmon'),(53,2,13,'Limón y Ajo'),(52,1,13,'Chili'),(52,2,13,'Chile'),(51,1,13,'Trufa'),(51,2,13,'Trufa'),(50,1,13,'Orange Basil'),(50,2,13,'Naranja y Albahaca'),(55,2,14,'Naranja y Albahaca'),(55,1,14,'oil'),(56,2,14,'Trufa'),(56,1,14,'Trufa'),(57,2,14,'Chile'),(57,1,14,'Chiñi'),(58,2,14,'Limón y ajo'),(58,1,14,'lemon'),(59,2,14,'Romero'),(59,1,14,'Romero'),(60,2,14,'Lemongrass'),(60,1,14,'Lemongrass'),(54,1,13,'Romero'),(49,2,13,'Lemongrass'),(49,1,13,'lemongrass'),(61,2,15,'Naranja y Albahaca'),(61,1,15,'Orange'),(62,2,15,'Romero'),(62,1,15,'Romero'),(63,2,15,'Limón y Ajo'),(63,1,15,'Lemon'),(64,2,15,'Chile'),(64,1,15,'Chili'),(65,2,15,'Trufa'),(65,1,15,'Trufa'),(66,2,15,'Lemongrass'),(66,1,15,'Lemongrass'),(67,2,16,'Naranja y Albahaca'),(67,1,16,'orange'),(68,2,16,'Lemongrass'),(68,1,16,'Lemongrass'),(69,2,16,'Trufa'),(69,1,16,'trufa'),(70,2,16,'Chile'),(70,1,16,'Chili'),(71,2,16,'Limón y Ajo'),(71,1,16,'lemon'),(72,2,16,'Romero'),(72,1,16,'Romero');
...
INSERT INTO `oc_order` VALUES (1,0,'INV-2013-00',0,'Qfresh.co','http://localhost/Market-new/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Cash On Delivery','cod','','','','','','','','',0,'',0,'','[]','','','',19.9000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-27 17:53:50','2016-04-27 17:53:52'),(2,0,'INV-2013-00',0,'Qfresh.co','http://localhost/Market-new/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Cash On Delivery','cod','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Horario de mañana','MM','',19.9000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-27 18:35:10','2016-04-27 18:35:40'),(3,0,'INV-2013-00',0,'Qfresh.co','http://localhost/Market-new/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Stripe','advertikon_stripe','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Horario de mañana','MM','',39.8000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-27 21:35:52','2016-04-27 21:36:53'),(4,1,'INV-2013-00',0,'Qfresh.co','http://localhost/Market-new/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Stripe','advertikon_stripe','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Horario de tarde','MM','',39.8000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-27 22:06:48','2016-04-27 22:08:42'),(5,0,'INV-2013-00',0,'Qfresh.co','http://localhost/Market-new/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Stripe','advertikon_stripe','viactor','nunez','','diego velazquez 19','diego velazquez 19','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana','MM','',39.8000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-28 09:54:27','2016-04-28 09:54:27'),(6,0,'INV-2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'victor','nunez','vnunmar@gmail.com','628718498','','[]','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Tarifa plana de env&iacute;o','flat.flat','entregado correctamente',45.8500,5,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-28 11:41:44','2016-04-28 13:40:36'),(7,0,'INV-2016-00',0,'Qfresh.co','http://localhost:8081/',4,1,'victor','nunez','vnunez@visiona-ip.es','628718498','','','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Stripe','advertikon_stripe','victor','nunez','','calle sin nombre 15','','alcobendas','48202','Spain',195,'Madrid',3001,'','[]','Horario de tarde','MM','',573.5400,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36','es-ES,es;q=0.8','2016-04-28 17:54:43','2016-04-28 17:54:43'),(8,1,'INV-2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana','MM','',126.8000,5,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.76 Mobile Safari/537.36','es-ES,es;q=0.8','2016-04-29 15:27:18','2016-04-29 16:24:15'),(9,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de tarde (16 - 21h )','MM','',199.0000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 12:29:24','2016-05-25 12:29:24'),(10,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','',199.0000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 12:49:31','2016-05-25 12:49:31'),(11,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','[]','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Tarifa plana de env&iacute;o','flat.flat','',205.0500,5,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:00:51','2016-06-06 10:59:58'),(12,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','',159.2000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:13:49','2016-05-25 16:14:03'),(13,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','',119.4000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:22:38','2016-05-25 16:22:51'),(14,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','',199.0000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:24:26','2016-05-25 16:24:26'),(15,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','mensaje de prueba',199.0000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:24:40','2016-05-25 16:24:55'),(16,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','mensaje de prueba',79.6000,1,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:26:37','2016-05-25 16:26:51'),(17,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','mensaje de prueba',79.6000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:51:47','2016-05-25 16:51:47'),(18,0,'2016-00',0,'Qfresh.co','http://localhost:8081/',3,1,'Víctor','Nuñez','vnunmar@gmail.com','628718498','','','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Stripe','advertikon_stripe','victor','nunez','','diego velazquez 19','','mojados','47250','Spain',195,'Valladolid',3018,'','[]','Horario de mañana ( 9 - 13h )','MM','mensaje de prueba',139.3000,0,0,0.0000,0,'',2,3,'EUR',0.88330001,'127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36','en-US,en;q=0.8,es;q=0.6','2016-05-25 16:52:59','2016-05-25 16:52:59');
...
INSERT INTO `oc_order_history` VALUES (1,1,1,0,'','2016-04-27 17:53:52'),(2,2,1,0,'','2016-04-27 18:35:40'),(3,3,1,0,'','2016-04-27 21:36:53'),(4,4,1,0,'','2016-04-27 22:07:19'),(5,4,1,0,'','2016-04-27 22:08:42'),(6,6,1,1,'','2016-04-28 11:42:16'),(7,6,0,0,'','2016-04-28 13:40:11'),(8,6,5,0,'','2016-04-28 13:40:12'),(9,6,0,0,'','2016-04-28 13:40:36'),(10,6,5,0,'','2016-04-28 13:40:37'),(11,8,1,1,'','2016-04-29 15:27:38'),(12,8,5,1,'todo ok','2016-04-29 16:24:16'),(13,11,1,1,'','2016-05-25 16:01:09'),(14,11,1,1,'','2016-05-25 16:08:06'),(15,12,1,1,'','2016-05-25 16:14:03'),(16,13,1,1,'','2016-05-25 16:22:51'),(17,15,1,1,'mensaje de prueba','2016-05-25 16:24:55'),(18,16,1,1,'mensaje de prueba','2016-05-25 16:26:51'),(19,11,0,0,'','2016-06-06 10:59:25'),(20,11,5,0,'','2016-06-06 10:59:27'),(21,11,0,0,'','2016-06-06 10:59:58'),(22,11,5,0,'','2016-06-06 10:59:59');
...
INSERT INTO `oc_order_option` VALUES (1,1,1,227,17,'Size','Small','select'),(2,3,3,227,17,'Size','Small','select'),(3,7,13,241,79,'Botella aceite aromático 1','Lemongrass','select'),(4,7,13,242,82,'Botella aceite aromático 2','Naranja y Albahaca','select'),(5,7,13,243,86,'Botella aceite aromático 3','Chile','select'),(6,7,13,244,94,'Botella aceite aromático 4','Trufa','select');
...
INSERT INTO `oc_order_product` VALUES (1,1,50,'Aceite de chile','Aceite de chile',1,19.9000,19.9000,0.0000,0),(2,2,51,'Aceite de limón y ajo','Aceite de limón y ajo',2,9.9500,19.9000,0.0000,0),(3,3,50,'Aceite de chile','Aceite de chile',1,19.9000,19.9000,0.0000,0),(4,3,51,'Aceite de limón y ajo','Aceite de limón y ajo',2,9.9500,19.9000,0.0000,0),(5,4,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(6,5,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(9,6,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(10,7,54,'Aceite aromático Lemongrass','Aceite aromático Lemongrass',4,10.9500,43.8000,1.0950,0),(11,7,56,'Pack Aceites Aromáticos','Pack Aceites Aromáticos',4,43.7800,175.1200,0.0000,0),(12,7,56,'Pack Aceites Aromáticos','Pack Aceites Aromáticos',4,43.7800,175.1200,0.0000,0),(13,7,56,'Pack Aceites Aromáticos','Pack Aceites Aromáticos',4,43.7800,175.1200,0.0000,0),(14,8,50,'Aceite de chile','Aceite de chile',8,5.9000,47.2000,0.0000,0),(15,8,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(16,8,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(17,9,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(18,9,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(19,9,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(20,10,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(21,10,51,'Aceite de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(22,10,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(45,11,51,'Aceite aromático de limón y ajo','Aceite de limón y ajo',4,9.9500,39.8000,0.0000,0),(46,11,52,'Aceite aromático de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(26,12,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(27,12,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(28,13,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(29,14,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(30,14,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(31,14,53,'Aceite de Trufa','Aceite de Trufa',4,9.9500,39.8000,0.0000,0),(32,15,50,'Aceite de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0),(33,15,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(34,15,53,'Aceite de Trufa','Aceite de Trufa',4,9.9500,39.8000,0.0000,0),(35,16,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(36,16,53,'Aceite de Trufa','Aceite de Trufa',4,9.9500,39.8000,0.0000,0),(37,17,52,'Aceite de Romero','Aceite de Romero',4,9.9500,39.8000,0.0000,0),(38,17,53,'Aceite de Trufa','Aceite de Trufa',4,9.9500,39.8000,0.0000,0),(39,18,52,'Aceite de Romero','Aceite de Romero',8,9.9500,79.6000,0.0000,0),(40,18,53,'Aceite de Trufa','Aceite de Trufa',6,9.9500,59.7000,0.0000,0),(44,11,50,'Aceite aromático de chile','Aceite de chile',12,9.9500,119.4000,0.0000,0);
...
INSERT INTO `oc_order_status` VALUES (3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(15,1,'Processed'),(2,2,'En preparación'),(3,2,'Enviado'),(7,2,'Cancelado'),(5,2,'Completado'),(8,2,'Denegado'),(1,2,'Pendiente'),(2,1,'Processing'),(15,2,'Procesado'),(1,1,'Pending');
...
INSERT INTO `oc_order_total` VALUES (1,1,'sub_total','Sub-Total',19.9000,1),(2,1,'total','Total',19.9000,9),(3,2,'sub_total','Sub-Total',19.9000,1),(4,2,'total','Total',19.9000,9),(5,3,'sub_total','Sub-Total',39.8000,1),(6,3,'total','Total',39.8000,9),(7,4,'sub_total','Sub-Total',39.8000,1),(8,4,'total','Total',39.8000,9),(9,5,'sub_total','Sub-Total',39.8000,1),(10,5,'total','Total',39.8000,9),(19,6,'tax','IVA',1.0500,5),(20,6,'total','Total',45.8500,9),(18,6,'shipping','Tarifa plana de env&iacute;o',5.0000,3),(17,6,'sub_total','Sub-Total',39.8000,1),(21,7,'sub_total','Sub-Total',569.1600,1),(22,7,'tax','IVA Aceite',4.3800,5),(23,7,'total','Total',573.5400,9),(24,8,'sub_total','Sub-Total',126.8000,1),(25,8,'total','Total',126.8000,9),(26,9,'sub_total','Sub-Total',199.0000,1),(27,9,'total','Total',199.0000,9),(28,10,'sub_total','Sub-Total',199.0000,1),(29,10,'total','Total',199.0000,9),(52,11,'tax','IVA',1.0500,5),(53,11,'total','Total',205.0500,9),(32,12,'sub_total','Sub-Total',159.2000,1),(33,12,'total','Total',159.2000,9),(34,13,'sub_total','Sub-Total',119.4000,1),(35,13,'total','Total',119.4000,9),(36,14,'sub_total','Sub-Total',199.0000,1),(37,14,'total','Total',199.0000,9),(38,15,'sub_total','Sub-Total',199.0000,1),(39,15,'total','Total',199.0000,9),(40,16,'sub_total','Sub-Total',79.6000,1),(41,16,'total','Total',79.6000,9),(42,17,'sub_total','Sub-Total',79.6000,1),(43,17,'total','Total',79.6000,9),(44,18,'sub_total','Sub-Total',139.3000,1),(45,18,'total','Total',139.3000,9),(51,11,'shipping','Tarifa plana de env&iacute;o',5.0000,3),(50,11,'sub_total','Sub-Total',199.0000,1);
...
INSERT INTO `oc_pavblog_blog` VALUES (7,21,2,'2013-03-09',1,1,47,'data/pavblog/pav-i1.jpg','','','','2013-04-04','','','joomla, prestashop, magento',1,''),(9,21,0,'2013-03-09',1,1,74,'data/pavblog/pav-i1.jpg','','','','2013-04-04','','','prestashop, magento',0,''),(10,21,0,'2013-03-09',1,1,227,'data/pavblog/pav-i1.jpg','test test','','Custom SEO Titlte','2013-04-04','&lt;iframe width=&quot;560&quot; height=&quot;315&quot; src=&quot;http://www.youtube.com/embed/-ZsFrs2O8pI&quot; frameborder=&quot;0&quot; allowfullscreen&gt;&lt;/iframe&gt;','','prestashop',0,''),(11,21,0,'2013-03-11',1,1,58,'data/pavblog/pav-i1.jpg','','','','2013-04-04','','','opencart',0,'');
...
INSERT INTO `oc_pavblog_category` VALUES (1,'',0,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,0,0,NULL,NULL,0,'top',NULL,NULL,NULL,NULL,-5,34,47,''),(20,'data/pavblog/pav-c3.jpg',22,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,3,0,NULL,NULL,0,'top','test test',NULL,NULL,NULL,0,0,0,''),(21,'data/pavblog/pav-c1.jpg',22,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,1,0,NULL,NULL,0,'top','',NULL,NULL,NULL,0,0,0,''),(22,'data/demo/canon_eos_5d_1.jpg',1,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,1,0,NULL,NULL,0,'top','',NULL,NULL,NULL,0,0,0,''),(23,'data/pavblog/pav-c2.jpg',22,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,2,0,NULL,NULL,0,'top','',NULL,NULL,NULL,0,0,0,''),(24,'data/logo.png',1,2,NULL,NULL,NULL,NULL,NULL,'1','',2,1,'1',0,1,0,2,0,NULL,NULL,0,'top','',NULL,NULL,NULL,0,0,0,'');
...
INSERT INTO `oc_product` VALUES (50,'Aceite de chile','','','','','','','',142,6,'sellers/4/chili.jpg',0,1,9.9500,0,0,'2016-04-26',200.00000000,2,0.00000000,0.00000000,0.00000000,1,1,4,0,1,18,'2016-04-27 17:52:04','2016-06-02 16:28:07'),(51,'Aceite de limón y ajo','','','','','','','',179,6,'sellers/4/limon.ajo.jpg',0,1,9.9500,0,0,'2016-04-26',0.70000000,1,0.00000000,0.00000000,0.00000000,1,1,4,0,1,8,'2016-04-27 18:02:52','2016-06-02 16:28:20'),(52,'Aceite de Romero','','','','','','','',178,6,'catalog/romero.jpg',0,1,9.9500,0,0,'2016-04-26',200.00000000,2,0.00000000,0.00000000,0.00000000,1,1,4,0,1,9,'2016-04-28 01:27:42','2016-06-02 16:28:32'),(53,'Aceite de Trufa','','','','','','','',190,6,'catalog/trufa.jpg',0,1,9.9500,0,0,'2016-04-26',200.00000000,2,0.00000000,0.00000000,0.00000000,1,1,4,0,1,0,'2016-04-28 01:54:39','2016-06-02 16:28:42'),(54,'Aceite aromático Lemongrass','','','','','','','',198,6,'sellers/4/lemongrass.web.jpg',0,1,10.9500,0,11,'2016-04-27',0.63000000,1,5.00000000,19.00000000,0.00000000,1,1,4,0,1,14,'2016-04-28 12:32:07','2016-04-28 17:57:47'),(55,'Aceite aromático Naranja y Albahaca','','','','','','','',198,0,'sellers/4/orange.basil.web.jpg',0,1,9.9500,0,0,'2016-04-27',200.00000000,2,0.00000000,0.00000000,0.00000000,1,1,4,0,1,0,'2016-04-28 13:29:54','2016-04-28 15:44:58'),(56,'Pack Aceites Aromáticos','','','','','','','',198,6,'sellers/4/caja.4.luxury.op.sg.jpg',0,1,43.7800,0,0,'2016-04-27',200.00000000,2,0.00000000,0.00000000,0.00000000,1,1,0,0,1,24,'2016-04-28 15:04:38','2016-04-28 15:48:33');
...
INSERT INTO `oc_product_attribute` VALUES (54,12,1,'Ud'),(55,12,2,'Ud'),(55,12,1,'Ud'),(56,12,1,'Pack'),(54,12,2,'Ud'),(50,12,1,'Ud'),(50,12,2,'Ud'),(51,12,1,'Ud'),(51,12,2,'Ud'),(52,12,1,'Ud'),(52,12,2,'Ud'),(53,12,1,'Ud'),(53,12,2,'Ud'),(56,12,2,'Pack');
...
INSERT INTO `oc_product_description` VALUES (50,2,'Aceite aromático de chile','&lt;p&gt;Aceite de oliva organico con sabora a chile&lt;/p&gt;','','Aceite de chile','',''),(50,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(51,2,'Aceite aromático de limón y ajo','&lt;p&gt;Aceite de oliva organico con sabora a&amp;nbsp;limón y ajo&lt;/p&gt;','','Aceite de limón y ajo','',''),(51,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(52,2,'Aceite aromático de Romero','&lt;p&gt;Aceite de oliva organico con sabor&amp;nbsp;a romero&lt;/p&gt;','','Aceite de Romero','',''),(52,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(53,2,'Aceite aromático de Trufa','&lt;p&gt;Aceite de oliva organico con sabor&amp;nbsp;a trufa&lt;/p&gt;','','Aceite de Trufa','',''),(53,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(54,2,'Aceite aromático Lemongrass','&lt;p&gt;Aceite de oliva organico con sabor&amp;nbsp;a lemongrass&lt;/p&gt;','','Aceite aromático Lemongrass','',''),(54,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(55,2,'Aceite aromático Naranja y Albahaca','&lt;p&gt;Aceite de oliva organico con sabor&amp;nbsp;a Naranja y Albahaca&lt;/p&gt;','','Aceite aromático Naranja y Albahaca','',''),(55,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','',''),(56,2,'Pack Aceites Aromáticos','&lt;p&gt;Pack de 4 botellas de aceite aromatico. 6 sabores diferentes.&lt;/p&gt;','','Pack Aceites Aromáticos','',''),(56,1,'Chilli oil','&lt;p&gt;Organic Extra Virgin Flavoured Olive Oil - CHILLI&lt;/p&gt;','','Chilli oil','','');
...
INSERT INTO `oc_product_image` VALUES (2364,56,'sellers/4/lemongrass.web-1.jpg',4),(2363,56,'sellers/4/limon.ajo-1.jpg',3),(2362,56,'sellers/4/romero.jpg',2),(2361,56,'sellers/4/chili-1.jpg',1),(2360,56,'sellers/4/trufa.jpg',0),(2365,56,'sellers/4/orange.basil.web-1.jpg',5);
...
INSERT INTO `oc_product_option` VALUES (241,56,13,'',1),(242,56,14,'',1),(243,56,15,'',1),(244,56,16,'',1);
...
INSERT INTO `oc_product_option_value` VALUES (86,243,56,15,64,0,0,0.0000,'+',0,'+',0.00000000,'+'),(87,243,56,15,63,0,0,0.0000,'+',0,'+',0.00000000,'+'),(88,243,56,15,62,0,0,0.0000,'+',0,'+',0.00000000,'+'),(89,243,56,15,61,0,0,0.0000,'+',0,'+',0.00000000,'+'),(90,243,56,15,66,0,0,0.0000,'+',0,'+',0.00000000,'+'),(91,243,56,15,65,0,0,0.0000,'+',0,'+',0.00000000,'+'),(92,244,56,16,71,0,0,0.0000,'+',0,'+',0.00000000,'+'),(93,244,56,16,70,0,0,0.0000,'+',0,'+',0.00000000,'+'),(94,244,56,16,69,0,0,0.0000,'+',0,'+',0.00000000,'+'),(95,244,56,16,68,0,0,0.0000,'+',0,'+',0.00000000,'+'),(96,244,56,16,67,0,0,0.0000,'+',0,'+',0.00000000,'+'),(97,244,56,16,72,0,0,0.0000,'+',0,'+',0.00000000,'+'),(85,242,56,14,58,0,0,0.0000,'+',0,'+',0.00000000,'+'),(84,242,56,14,59,0,0,0.0000,'+',0,'+',0.00000000,'+'),(83,242,56,14,60,0,0,0.0000,'+',0,'+',0.00000000,'+'),(82,242,56,14,55,0,0,0.0000,'+',0,'+',0.00000000,'+'),(81,242,56,14,56,0,0,0.0000,'+',0,'+',0.00000000,'+'),(80,242,56,14,57,0,0,0.0000,'+',0,'+',0.00000000,'+'),(79,241,56,13,49,0,0,0.0000,'+',0,'+',0.00000000,'+'),(78,241,56,13,50,0,0,0.0000,'+',0,'+',0.00000000,'+'),(77,241,56,13,51,0,0,0.0000,'+',0,'+',0.00000000,'+'),(76,241,56,13,52,0,0,0.0000,'+',0,'+',0.00000000,'+'),(75,241,56,13,53,0,0,0.0000,'+',0,'+',0.00000000,'+'),(74,241,56,13,54,0,0,0.0000,'+',0,'+',0.00000000,'+');
...
INSERT INTO `oc_product_special` VALUES (441,50,1,1,5.9000,'2016-04-29','2016-05-04');
...
INSERT INTO `oc_product_to_category` VALUES (50,60),(50,66),(51,60),(51,66),(52,60),(52,66),(53,60),(53,66),(54,60),(54,66),(55,60),(55,66),(56,60),(56,66);
...
INSERT INTO `oc_product_to_layout` VALUES (50,0,0),(51,0,0),(52,0,0),(53,0,0),(54,0,0),(56,0,0);
...
INSERT INTO `oc_product_to_store` VALUES (50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0);
...
INSERT INTO `oc_return_action` VALUES (1,1,'Refunded'),(3,2,'Producto enviado de nuevo'),(1,2,'En espera'),(2,2,'Devolución de dinero emitida'),(2,1,'Credit Issued'),(3,1,'Replacement Sent');
...
INSERT INTO `oc_return_reason` VALUES (5,1,'Other, please supply details'),(1,2,'El producto no me llega'),(2,2,'Artículo incorrecto'),(3,2,'Pedido erroneo'),(4,2,'Defectuoso, especificar detalles'),(5,2,'Otras causas, comente detalles'),(4,1,'Faulty, please supply details'),(3,1,'Order Error'),(2,1,'Received Wrong Item'),(1,1,'Dead On Arrival');
...
INSERT INTO `oc_return_status` VALUES (3,1,'Complete'),(1,2,'Pendiente'),(3,2,'Completa'),(2,2,'Esperando los productos'),(2,1,'Awaiting Products'),(1,1,'Pending');
...
) ENGINE=MyISAM AUTO_INCREMENT=7832 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oc_setting` VALUES (1,0,'shipping','shipping_sort_order','3',0),(2,0,'sub_total','sub_total_sort_order','1',0),(3,0,'sub_total','sub_total_status','1',0),(4,0,'tax','tax_status','1',0),(5,0,'total','total_sort_order','9',0),(6,0,'total','total_status','1',0),(7,0,'tax','tax_sort_order','5',0),(14,0,'shipping','shipping_status','1',0),(15,0,'shipping','shipping_estimator','1',0),(27,0,'coupon','coupon_sort_order','4',0),(28,0,'coupon','coupon_status','1',0),(34,0,'flat','flat_sort_order','1',0),(35,0,'flat','flat_status','1',0),(36,0,'flat','flat_geo_zone_id','0',0),(37,0,'flat','flat_tax_class_id','9',0),(41,0,'flat','flat_cost','5.00',0),(42,0,'credit','credit_sort_order','7',0),(43,0,'credit','credit_status','1',0),(53,0,'reward','reward_sort_order','2',0),(54,0,'reward','reward_status','1',0),(146,0,'category','category_status','1',0),(158,0,'account','account_status','1',0),(159,0,'affiliate','affiliate_status','1',0),(6365,0,'adk_stripe_','adk_stripe_live_public_key','pk_live_aCwTShbWbXbLpwND4ZIdbaEV',0),(94,0,'voucher','voucher_sort_order','8',0),(95,0,'voucher','voucher_status','1',0),(7488,0,'weight','weight_6_rate','',0),(7489,0,'weight','weight_6_status','0',0),(7485,0,'weight','weight_sort_order','3',0),(7484,0,'weight','weight_status','1',0),(7483,0,'weight','weight_tax_class_id','9',0),(7830,0,'config','config_error_log','1',0),(7831,0,'config','config_error_filename','error.log',0),(7826,0,'config','config_file_max_size','300000',0),(7827,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),(7828,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf',0),(7829,0,'config','config_error_display','1',0),(7825,0,'config','config_encryption','',0),(7812,0,'config','config_mail_smtp_hostname','ssl://smtp.gmail.com',0),(7813,0,'config','config_mail_smtp_username','qfreshco@gmail.com',0),(7814,0,'config','config_mail_smtp_password','DEFCON2Gr0w&amp;L1nk2015',0),(7815,0,'config','config_mail_smtp_port','465',0),(7816,0,'config','config_mail_smtp_timeout','5',0),(7817,0,'config','config_mail_alert','vnunez@visiona-ip.es',0),(7818,0,'config','config_maintenance','0',0),(7819,0,'config','config_seo_url','0',0),(7820,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(7821,0,'config','config_compression','0',0),(7822,0,'config','config_secure','0',0),(7823,0,'config','config_password','1',0),(7824,0,'config','config_shared','0',0),(7003,0,'msconf','msconf_allow_partial_withdrawal','1',0),(7002,0,'msconf','msconf_hide_customer_email','1',0),(7001,0,'msconf','msconf_enable_private_messaging','2',0),(7000,0,'msconf','msconf_enable_update_seo_urls','0',0),(6999,0,'msconf','msconf_enable_seo_urls_product','0',0),(6998,0,'msconf','msconf_graphical_sellermenu','1',0),(6997,0,'msconf','msconf_provide_buyerinfo','0',0),(6996,0,'msconf','msconf_allow_specials','1',0),(6995,0,'msconf','msconf_attribute_display','1',0),(6994,0,'msconf','msconf_enable_seller_banner','1',0),(6993,0,'msconf','msconf_display_order_statuses','[\"7\",\"5\",\"8\",\"2\",\"3\",\"1\",\"15\"]',1),(6992,0,'msconf','msconf_additional_category_restrictions','0',0),(6991,0,'msconf','msconf_disable_product_after_quantity_depleted','0',0),(6990,0,'msconf','msconf_allow_discounts','1',0),(6989,0,'msconf','msconf_allow_inactive_seller_products','0',0),(6988,0,'msconf','msconf_withdrawal_waiting_period','0',0),(6987,0,'msconf','msconf_notification_email','',0),(6986,0,'msconf','msconf_minimum_withdrawal_amount','50',0),(6985,0,'msconf','msconf_enable_rte','1',0),(6984,0,'msconf','msconf_sellers_slug','sellers',0),(6983,0,'msconf','msconf_min_uploaded_image_width','0',0),(6982,0,'msconf','msconf_min_uploaded_image_height','0',0),(6981,0,'msconf','msconf_max_uploaded_image_width','0',0),(6980,0,'msconf','msconf_product_seller_banner_height','100',0),(6979,0,'msconf','msconf_preview_seller_avatar_image_height','100',0),(6603,0,'mxtconf','mxtconf_installed','1',0),(6606,0,'msconf_badge','msconf_badge_enabled','0',0),(6605,0,'msconf_badge','msconf_badge_width','30',0),(6604,0,'msconf_badge','msconf_badge_height','30',0),(6608,0,'msconf_sl','msconf_sl_icon_width','75',0),(6607,0,'msconf_sl','msconf_sl_icon_height','75',0),(6610,0,'mmess_conf','mmess_conf_enable','1',0),(6978,0,'msconf','msconf_product_seller_product_list_seller_area_image_height','40',0),(6977,0,'msconf','msconf_max_uploaded_image_height','0',0),(6976,0,'msconf','msconf_product_seller_products_image_width','100',0),(6975,0,'msconf','msconf_product_seller_products_image_height','100',0),(6974,0,'msconf','msconf_change_seller_nickname','1',0),(6973,0,'msconf','msconf_product_seller_product_list_seller_area_image_width','40',0),(6972,0,'msconf','msconf_product_seller_banner_width','750',0),(6971,0,'msconf','msconf_enable_quantities','1',0),(6970,0,'msconf','msconf_preview_product_image_height','100',0),(6969,0,'msconf','msconf_product_seller_profile_image_width','100',0),(6968,0,'msconf','msconf_preview_seller_avatar_image_width','100',0),(6967,0,'msconf','msconf_temp_download_path','tmp/',0),(7811,0,'config','config_mail_parameter','',0),(7810,0,'config','config_mail_protocol','smtp',0),(7809,0,'config','config_ftp_status','0',0),(7808,0,'config','config_ftp_root','',0),(7807,0,'config','config_ftp_password','',0),(7806,0,'config','config_ftp_username','',0),(7805,0,'config','config_ftp_port','21',0),(7804,0,'config','config_ftp_hostname','localhost',0),(7803,0,'config','config_image_location_height','50',0),(7802,0,'config','config_image_location_width','268',0),(7801,0,'config','config_image_cart_height','47',0),(7800,0,'config','config_image_cart_width','47',0),(7799,0,'config','config_image_wishlist_height','47',0),(7798,0,'config','config_image_wishlist_width','47',0),(7797,0,'config','config_image_compare_height','90',0),(647,0,'msship','msship_product_shipping_cost_estimation','1',0),(648,0,'msship','msship_enable_minicart_shipping_estimate','1',0),(6966,0,'msconf','msconf_default_seller_group_id','1',0),(6364,0,'adk_stripe_','adk_stripe_live_secret_key','sk_live_lMqLvHAiAiElHp3XvTVpPPI6',0),(6363,0,'adk_stripe_','adk_stripe_extension_commented','1',0),(6362,0,'adk_stripe_','adk_stripe_customer_description','{storeName}. {customerName}',0),(6361,0,'adk_stripe_','adk_stripe_installed','1',0),(6359,0,'adk_stripe_','adk_stripe_debug','0',0),(6360,0,'adk_stripe_','adk_stripe_use_oclog','1',0),(6358,0,'adk_stripe_','adk_stripe_log_file','payment_advertikon_stripe.log',0),(6357,0,'adk_stripe_','adk_stripe_test_mode','1',0),(6356,0,'adk_stripe_','adk_stripe_geo_zone','[\"0\",\"5\",\"6\"]',1),(6355,0,'adk_stripe_','adk_stripe_zip_check','1',0),(6354,0,'adk_stripe_','adk_stripe_cvc_check','1',0),(6353,0,'adk_stripe_','adk_stripe_uninstall_clear_settings','1',0),(6352,0,'adk_stripe_','adk_stripe_charge_description','{storeName}. Order #{orderId} for {customerName}',0),(6351,0,'adk_stripe_','adk_stripe_status_authorized','1',0),(6350,0,'adk_stripe_','adk_stripe_total_max','0',0),(6349,0,'adk_stripe_','adk_stripe_address_check','0',0),(6348,0,'adk_stripe_','adk_stripe_save_card_data','0',0),(6347,0,'adk_stripe_','adk_stripe_status_voided','5',0),(6373,0,'advertikon_stripe_','advertikon_stripe_sort_order','1',0),(6346,0,'adk_stripe_','adk_stripe_uninstall_clear_db','1',0),(6345,0,'adk_stripe_','adk_stripe_title','Stripe',0),(6344,0,'adk_stripe_','adk_stripe_status_captured','1',0),(7796,0,'config','config_image_compare_width','90',0),(7795,0,'config','config_image_related_height','80',0),(7794,0,'config','config_image_related_width','80',0),(7793,0,'config','config_image_additional_height','74',0),(7792,0,'config','config_image_additional_width','74',0),(2059,0,'free','free_total','150',0),(2060,0,'free','free_geo_zone_id','0',0),(2061,0,'free','free_status','1',0),(2062,0,'free','free_sort_order','2',0),(7791,0,'config','config_image_product_height','228',0),(7790,0,'config','config_image_product_width','228',0),(7789,0,'config','config_image_popup_height','500',0),(7788,0,'config','config_image_popup_width','500',0),(7787,0,'config','config_image_thumb_height','228',0),(7786,0,'config','config_image_thumb_width','228',0),(7781,0,'config','config_captcha_page','[\"review\",\"return\",\"contact\"]',1),(7785,0,'config','config_image_category_height','80',0),(7784,0,'config','config_image_category_width','80',0),(7783,0,'config','config_icon','catalog/logo1.png',0),(7782,0,'config','config_logo','catalog/Qfreshco letras verde.png',0),(7780,0,'config','config_captcha','',0),(7779,0,'config','config_return_status_id','1',0),(7778,0,'config','config_return_id','5',0),(7777,0,'config','config_affiliate_mail','1',0),(7776,0,'config','config_affiliate_id','4',0),(7775,0,'config','config_affiliate_commission','5',0),(7774,0,'config','config_affiliate_auto','0',0),(7773,0,'config','config_affiliate_approval','0',0),(7772,0,'config','config_stock_checkout','0',0),(7771,0,'config','config_stock_warning','0',0),(7770,0,'config','config_stock_display','0',0),(7769,0,'config','config_api_id','1',0),(7768,0,'config','config_order_mail','1',0),(7767,0,'config','config_fraud_status_id','8',0),(7766,0,'config','config_complete_status','[\"5\"]',1),(7765,0,'config','config_processing_status','[\"5\",\"2\",\"3\",\"1\"]',1),(7764,0,'config','config_order_status_id','1',0),(7763,0,'config','config_checkout_id','5',0),(7762,0,'config','config_checkout_guest','0',0),(7761,0,'config','config_cart_weight','0',0),(6965,0,'msconf','msconf_seller_avatar_dashboard_image_width','100',0),(6964,0,'msconf','msconf_seller_avatar_dashboard_image_height','100',0),(6963,0,'msconf','msconf_rte_whitelist','',0),(6962,0,'msconf','msconf_product_seller_profile_image_height','100',0),(6961,0,'msconf','msconf_preview_product_image_width','100',0),(6960,0,'msconf','msconf_seller_avatar_seller_list_image_height','228',0),(6959,0,'msconf','msconf_seller_avatar_seller_list_image_width','228',0),(6958,0,'msconf','msconf_seller_avatar_product_page_image_width','100',0),(6957,0,'msconf','msconf_seller_avatar_seller_profile_image_height','100',0),(6956,0,'msconf','msconf_seller_avatar_product_page_image_height','100',0),(6955,0,'msconf','msconf_seller_avatar_seller_profile_image_width','100',0),(6954,0,'msconf','msconf_downloads_limits','[\"0\",\"0\"]',1),(6953,0,'msconf','msconf_allow_relisting','0',0),(6366,0,'adk_stripe_','adk_stripe_test_public_key','pk_test_lyc0q1fGXKkLGFfLEetKDvQz',0),(6367,0,'adk_stripe_','adk_stripe_total_min','0.44',0),(6368,0,'adk_stripe_','adk_stripe_payment_method','0',0),(6369,0,'adk_stripe_','adk_stripe_show_card_image','1',0),(6370,0,'adk_stripe_','adk_stripe_payment_currency','2',0),(6371,0,'adk_stripe_','adk_stripe_test_secret_key','sk_test_MxAWytMGCBeOLhqsqxcq0xXG',0),(6372,0,'adk_stripe_','adk_stripe_statement_descriptor','',0),(6374,0,'advertikon_stripe_','advertikon_stripe_status','1',0),(6609,0,'msconf_sl','msconf_sl_status','1',0),(7760,0,'config','config_invoice_prefix','2016-00',0),(7759,0,'config','config_account_mail','1',0),(7758,0,'config','config_account_id','3',0),(7757,0,'config','config_login_attempts','5',0),(7756,0,'config','config_customer_price','0',0),(7755,0,'config','config_customer_group_display','[\"1\"]',1),(7754,0,'config','config_customer_group_id','1',0),(7753,0,'config','config_customer_online','0',0),(7752,0,'config','config_tax_customer','shipping',0),(7751,0,'config','config_tax_default','shipping',0),(7750,0,'config','config_tax','1',0),(7749,0,'config','config_voucher_max','1000',0),(7744,0,'config','config_limit_admin','20',0),(7745,0,'config','config_review_status','1',0),(7746,0,'config','config_review_guest','1',0),(7747,0,'config','config_review_mail','0',0),(7748,0,'config','config_voucher_min','1',0),(7743,0,'config','config_product_description_length','200',0),(7742,0,'config','config_product_limit','15',0),(7741,0,'config','config_product_count','1',0),(7740,0,'config','config_weight_class_id','1',0),(7739,0,'config','config_length_class_id','1',0),(7738,0,'config','config_currency_auto','0',0),(7737,0,'config','config_currency','EUR',0),(7736,0,'config','config_admin_language','es',0),(7735,0,'config','config_language','es',0),(7733,0,'config','config_country_id','195',0),(7734,0,'config','config_zone_id','3001',0),(7732,0,'config','config_comment','',0),(7731,0,'config','config_open','',0),(7730,0,'config','config_image','catalog/Qfreshco letras verde.png',0),(7728,0,'config','config_telephone','+34 91 449 64 81',0),(7729,0,'config','config_fax','',0),(7727,0,'config','config_email','qfreshco@gmail.com',0),(7726,0,'config','config_geocode','calle copenague, 12, las rozas, madrid, españa',0),(7725,0,'config','config_address','calle copenague, 12, las rozas, madrid, españa',0),(7724,0,'config','config_owner','Visiona-ip',0),(7004,0,'msconf','msconf_enable_seo_urls_seller','1',0),(7005,0,'msconf','msconf_enable_non_alphanumeric_seo','0',0),(7006,0,'msconf','msconf_enable_shipping','1',0),(7007,0,'msconf','msconf_seller_terms_page','5',0),(7008,0,'msconf','msconf_temp_image_path','tmp/',0),(7009,0,'msconf','msconf_product_image_path','sellers/',0),(7010,0,'msconf','msconf_images_limits','[\"0\",\"0\"]',1),(7011,0,'msconf','msconf_product_included_fields','[\"minOrderQty\"]',1),(7012,0,'msconf','msconf_restrict_categories','[]',1),(7013,0,'msconf','msconf_maximum_product_price','0',0),(7014,0,'msconf','msconf_allow_multiple_categories','1',0),(7015,0,'msconf','msconf_minimum_product_price','0',0),(7016,0,'msconf','msconf_allow_free_products','1',0),(7017,0,'msconf','msconf_allowed_image_types','png,jpg,jpeg',0),(7018,0,'msconf','msconf_allowed_download_types','zip,rar,pdf',0),(7019,0,'msconf','msconf_debit_order_statuses','[\"8\"]',1),(7020,0,'msconf','msconf_paypal_sandbox','1',0),(7021,0,'msconf','msconf_paypal_address','',0),(7022,0,'msconf','msconf_credit_order_statuses','[\"5\"]',1),(7023,0,'msconf','msconf_allow_withdrawal_requests','1',0),(7024,0,'msconf','msconf_nickname_rules','2',0),(7025,0,'msconf','msconf_product_validation','1',0),(7026,0,'msconf','msconf_seller_validation','1',0),(7486,0,'weight','weight_5_rate','',0),(7487,0,'weight','weight_5_status','0',0),(7723,0,'config','config_name','Qfresh.co',0),(7722,0,'config','config_layout_id','4',0),(7721,0,'config','config_template','default',0),(7720,0,'config','config_meta_keyword','',0),(7719,0,'config','config_meta_description','Qfresh.co',0),(7718,0,'config','config_meta_title','Qfresh.co',0);
...
INSERT INTO `oc_stock_status` VALUES (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2-3 Days'),(7,2,'En Stock'),(8,2,'Reserva'),(5,2,'Fuera de Stock'),(6,2,'2-3 Días');
...
INSERT INTO `oc_tax_class` VALUES (9,'Impuesto general','impuesto general','2009-01-06 23:21:53','2016-04-27 21:43:41'),(11,'Impuesto Art of Oil','Impuesto para los aceites Art of Oil','2016-04-28 15:36:43','0000-00-00 00:00:00');
...
INSERT INTO `oc_tax_rate` VALUES (88,5,'IVA',21.0000,'P','2016-04-27 18:24:19','2016-04-27 21:43:18'),(89,5,'IVA Aceite',10.0000,'P','2016-04-28 15:33:36','2016-04-28 15:34:20');
...
INSERT INTO `oc_tax_rule` VALUES (132,9,88,'shipping',1),(133,11,89,'shipping',0);
...
INSERT INTO `oc_url_alias` VALUES (859,'information_id=4','about_us'),(864,'seller_id=4','oleo-quirós'),(877,'product_id=50','aceite-de-chile'),(878,'product_id=51','aceite-de-limón-y-ajo'),(844,'category_id=59','huerta'),(845,'seller_id=3','tienda-de-victor'),(850,'category_id=64',''),(855,'category_id=69',''),(856,'category_id=70',''),(857,'category_id=71',''),(860,'information_id=6','delivery'),(875,'information_id=3','privacy'),(862,'information_id=5','terms');
...
INSERT INTO `oc_user` VALUES (1,1,'admin','f29c0576d6696c0df491ebd6e3ac5f4e9cbc7291','kKZNi4Yhg','John','Doe','vnunez@visiona-ip.es','','','127.0.0.1',1,'2016-04-26 14:32:29');
...
INSERT INTO `oc_weight_class_description` VALUES (1,1,'Kilo','kg'),(2,1,'Gram','g'),(1,2,'Kilo','kg'),(2,2,'Gramo','g');
...
INSERT INTO `oc_zone_to_geo_zone` VALUES (110,195,0,5,'2016-04-27 18:05:38','0000-00-00 00:00:00'),(111,195,3001,6,'2016-04-27 18:06:28','0000-00-00 00:00:00');
...
-- Dump completed on 2016-06-06 11:39:03
