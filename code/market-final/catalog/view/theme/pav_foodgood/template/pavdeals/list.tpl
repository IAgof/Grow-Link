		...
		<div id="content" class="<?php echo $class; ?> box productdeals"><?php echo $content_top; ?>
			...
			<div class="row product-filter">
				<div class="display">
					...
					<div class="btn-group">
						<button type="button" id="list-view" class="btn btn-default" data-toggle="tooltip" title="<?php echo $objlang->get("button_list"); ?>"></button>
						<button type="button" id="grid-view" class="btn btn-default" data-toggle="tooltip" title="<?php echo $objlang->get("button_grid"); ?>"></button>
					</div>
				</div>
									...
									<!-- count down -->
										...
										<div class="product-action">
											...
											<div class="cart">
												...
												<input type="button" value="<?php echo $button_cart; ?>" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" class="button" />			
											</div>
