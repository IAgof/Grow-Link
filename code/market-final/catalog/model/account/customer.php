...
class ModelAccountCustomer extends Model {
	...
	public function deleteCustomer($customer_id) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET status = '0', approved = '" . (int)!$customer_group_info['approval'] . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
