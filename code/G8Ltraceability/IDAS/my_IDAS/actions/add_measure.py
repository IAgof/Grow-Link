...
parser=argparse.ArgumentParser(
    description=''' Descripcion comandos -h ayuda,  ejemplo: python addmeasure.py -ce entity_name -m1 measure_value1 -m2 measure_value2 ''',
    epilog="""All's well that ends well.""")
#parser.add_argument('--foo', type=int, default=42, help='FOO!')
parser.add_argument('-ce', type=str, default=[1, 2, 3], help='name of entity to be created (example:  python addmeasure.py -ce entity_name -m1 measure_value1 -m2 measure_value2 )')
parser.add_argument('-m1', type=str, default=[1, 2, 3], help='name of entity to be created (example:  python addmeasure.py -ce entity_name -m1 measure_value1 -m2 measure_value2 )')
parser.add_argument('-m2', type=str, default=[1, 2, 3], help='name of entity to be created (example:  python addmeasure.py -ce entity_name -m1 measure_value1 -m2 measure_value2 )')
